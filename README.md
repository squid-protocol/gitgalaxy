...
radius, closeness and average path length is measured exactly as in full
precision (these are computed natively).
What needs the optional engines is betweenness and the other repo-topology
