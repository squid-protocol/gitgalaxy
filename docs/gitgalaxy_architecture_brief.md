...
| **Timestamp** | `2026-08-02T18:36:23.782043+00:00` |
| **Scan Duration** | `4.57s` |
| **Git Branch** | `main` |
| **Git Commit** | `ee583c491febc5351df50c72a6420ae1dc3ec1b2` |
...
| Assortativity | -0.3092 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
| Cyclic Density | 0.0% | % of files trapped in dependency loops (Static Friction). |
| Avg Path Length | 2.851 | Hops between files. Lower = Tighter coupling. |
| Articulation Pts | 36 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| PYTHON | 168 | 55167 | 79.2% |
| MARKDOWN | 29 | 0 | 13.7% |
| YAML | 8 | 481 | 3.8% |
| PLAINTEXT | 6 | 0 | 2.8% |
| SHELL | 1 | 22 | 0.5% |
...
> **Architectural Drift Z-Score:** `4.922`
...
|---|---|---|
| file_cluster_8 | 121 | 57.1% |
| file_cluster_13 | 32 | 15.1% |
| file_cluster_0 | 17 | 8.0% |
...
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 35 | 16.5% |
...
| Specification Exposure | 0.0 | 100.0 | 16.7 | 0.0 | 0.0 |
| Instability Exposure | 0.0 | 33.7 | 1.2 | 0.0 | 0.0 |
| Volatility Exposure | 0.0 | 87.7 | 7.9 | 0.0 | 0.0 |
...
1. **language_standards.py** (`gitgalaxy/standards/language_standards.py`) — 49 inbound connections
2. **_extraction_harness.py** (`tests/extraction/_extraction_harness.py`) — 32 inbound connections
...
| `tests/extraction/languages` | 32 | 2385.33 | 2.63% | 0.0% |
| `gitgalaxy/standards` | 8 | 2059.64 | 8.19% | 18.59% |
...
- **Unknown Dependencies:** `1122` packages imported that bypass the Zero-Trust whitelist.

## 11. CUMULATIVE RISK HITLIST (Top 10 Highest Risk Files)
> Cumulative Risk is the sum of all individual risk exposures. These files represent the highest multi-dimensional technical debt and architectural fragility.

### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **748.41**
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **683.03**
...
### 3. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **669.25**
...
### 4. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **669.07**
- **Archetype:** `file_cluster_8` (Distance: 12.524 IQR)
- **Magnitude:** 3862.46 | **LOC:** 3044 | **CtrlFlow:** 71.1% | **Authorship Centralization:** 63.6%
- **Primary Risk Drivers:** Spec Match (100.0%), Algorithmic Dos (100.0%), Logic Bomb (100.0%), Churn (87.69%)
- **Heaviest Functions:** `execute_pipeline` (Impact: 2143.0), `main` (Impact: 869.6), `_process_file_worker` (Impact: 611.9)

### 5. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **656.64**
...
### 6. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **656.35**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **653.12**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **647.22**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **640.12**
- **Archetype:** `file_cluster_13` (Distance: 10.632 IQR)
...
### 10. `gitgalaxy/recorders/sarif_recorder.py` (PYTHON) -> Cumulative Risk: **634.78**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` numpy, multiprocessing, com.example.gradle.Plugin, os, kotlin.collections.List, Numeric.LinearAlgebra, machine, os.path...
...
- **Top Global Matches:** file_cluster_8: 12.524, file_cluster_13: 12.661, file_cluster_7: 12.911
- **Magnitude:** 3862.46 | **LOC:** 3044 | **CtrlFlow:** 71.1% | **Authorship Centralization:** 63.6%
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 6.324
  * `Choke Point (Betweenness):` 0.001941 | `Ripple Effect (Closeness):` 0.014218
  * `Imports (Out-Degree: 30):` signal, DAG, gitgalaxy.recorders.gpu_recorder, importlib.util, multiprocessing, subprocess, zipfile, gitgalaxy.recorders.llm_recorder...
...
- **Top Global Matches:** file_cluster_13: 11.185, file_cluster_8: 11.249, file_cluster_16: 11.321
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 8.077
  * `Choke Point (Betweenness):` 4.1e-05 | `Ripple Effect (Closeness):` 0.023223
  * `Imports (Out-Degree: 1):` pathlib, gitgalaxy.standards.analysis_lens, networkx, networkx.algorithms, warnings, collections, typing, logging...
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.086
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.027574
  * `Imports (Out-Degree: 0):` gitgalaxy.standards, typing, re, logging, statistics, math, os
...
- **Top Global Matches:** file_cluster_8: 11.266, file_cluster_16: 11.432, file_cluster_13: 11.485
- **Magnitude:** 1175.2 | **LOC:** 536 | **CtrlFlow:** 70.2% | **Authorship Centralization:** 55.6%
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 6.053
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.01481
  * `Imports (Out-Degree: 0):` typing, os, statistics, math, logging
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, gitgalaxy.standards.language_standards, gitgalaxy.standards.gitgalaxy_config, typing, re, logging, math, time
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 4.794
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.018957
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 9.8e-05 | `Ripple Effect (Closeness):` 0.018957
  * `Imports (Out-Degree: 3):` gitgalaxy.standards.analysis_lens, gitgalaxy.standards.language_standards, gitgalaxy.core.spatial_correlation, bisect, tiktoken, collections, typing, re...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 6.053
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.01481
  * `Imports (Out-Degree: 0):` pathlib, gitgalaxy.standards, collections, typing, json, logging, statistics, heapq...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.galaxyscope, subprocess, os, pathlib, or, gitgalaxy.core.aperture, passes, tempfile...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, typing, json, re, os, logging
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 6.053
  * `Choke Point (Betweenness):` 2.3e-05 | `Ripple Effect (Closeness):` 0.01481
  * `Imports (Out-Degree: 1):` pathlib, gitgalaxy.standards, subprocess, typing, os, shutil, time, logging...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` with, gitgalaxy.standards.language_standards, gitgalaxy.core.prism, gitgalaxy.standards.gitgalaxy_config, gitgalaxy.core.spatial_mapper, pytest, unittest.mock, re...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, gitgalaxy.standards.analysis_lens, pandas, networkx, numpy, collections, typing, logging...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, gitgalaxy.standards.language_standards, only, com.example.MyClass, ..., static, java.util., java.util.List...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 5.874
  * `Choke Point (Betweenness):` 0.000203 | `Ripple Effect (Closeness):` 0.004739
  * `Imports (Out-Degree: 9):` pathlib, gitgalaxy.licensing, gitgalaxy.tools.cobol_to_cobol.cobol_lexical_patcher, datetime, sqlite3, gitgalaxy.tools.cobol_to_cobol.cobol_jcl_forge, gitgalaxy.tools.cobol_to_cobol.cobol_jcl_auditor, gitgalaxy.tools.cobol_to_cobol.cobol_microservice_slicer...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, ast, typing, json, argparse, sys
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 356.56 | **LOC:** 12641 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` type, java.util., scala.util., inside, typing, re, scala.util.chaining., was...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` dataclasses, gitgalaxy.standards, copy, yaml, typing, logging, __future__
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` tempfile, pytest, gitgalaxy.recorders.sarif_recorder, which, json, os, gitgalaxy.metrics.signal_processor, identity
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.tools.supply_chain_security.supply_chain_firewall, pathlib, policy, bypassed, yaml, gitgalaxy.standards.config_resolver, multiprocessing, pytest...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.175
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` org.springframework.stereotype.Service, pathlib, gitgalaxy.tools.cobol_to_java.cobol_to_java_api_contract_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_decoder_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_build_forge, org.slf4j.LoggerFactory, gitgalaxy.licensing, gitgalaxy.tools.cobol_to_java.cobol_to_java_service_forge...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Top Global Matches:** file_cluster_13: 10.632, file_cluster_8: 10.718, file_cluster_16: 11.046
- **Magnitude:** 283.32 | **LOC:** 351 | **CtrlFlow:** 51.9% | **Authorship Centralization:** 100.0%
- **Algorithmic:** O(N^6) | **DB Complexity:** 6
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 7.403
  * `Choke Point (Betweenness):` 0.000181 | `Ripple Effect (Closeness):` 0.018957
  * `Imports (Out-Degree: 4):` pathlib, gitgalaxy.security.security_lens, gitgalaxy.standards.language_standards, gitgalaxy.security.manifest_parser, gitgalaxy.standards.language_lens, gitgalaxy.standards.gitgalaxy_config, uuid, typing...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Defense:* `doc: 10`
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 3.894
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.01481
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 6.053
  * `Choke Point (Betweenness):` 2.3e-05 | `Ripple Effect (Closeness):` 0.01481
  * `Imports (Out-Degree: 1):` pathlib, gitgalaxy.standards.gitgalaxy_config, typing, json, fnmatch, re, os, logging
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **67.96%** | Cog Load: 63.0362% | Debt: 0.0%
...
- `gitgalaxy/galaxyscope.py` -> **Severity: 0.151** (Bridge: 0.0019 * Flux: 77.6198%)
- `gitgalaxy/cobol_refractor_controller.py` -> **Severity: 0.02** (Bridge: 0.0002 * Flux: 97.0538%)
- `gitgalaxy/recorders/sbom_recorder.py` -> **Severity: 0.018** (Bridge: 0.0002 * Flux: 97.0328%)
...
- `gitgalaxy/standards/config_resolver.py` -> **Severity: 4.062** (Embedded: 0.0508 * Error Risk: 80.0%)
- `gitgalaxy/core/network_risk_sensor.py` -> **Severity: 1.691** (Embedded: 0.0232 * Error Risk: 72.8082%)
- `gitgalaxy/recorders/sarif_recorder.py` -> **Severity: 1.197** (Embedded: 0.019 * Error Risk: 63.1492%)
- `gitgalaxy/tools/ai_guardrails/ai_appsec_sensor.py` -> **Severity: 1.185** (Embedded: 0.0148 * Error Risk: 80.0%)
- `gitgalaxy/recorders/llm_recorder.py` -> **Severity: 1.143** (Embedded: 0.0148 * Error Risk: 77.1505%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `gitgalaxy/standards/config_resolver.py` -> **Severity: 2489.7** (Blast Radius: 24.897 * Doc Risk: 100.0%)
- `gitgalaxy/standards/language_standards.py` -> **Severity: 1415.51** (Blast Radius: 82.321 * Doc Risk: 17.195%)
- `gitgalaxy/metrics/tensor_scanner.py` -> **Severity: 605.3** (Blast Radius: 6.053 * Doc Risk: 100.0%)
- `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` -> **Severity: 587.4** (Blast Radius: 5.874 * Doc Risk: 100.0%)
- `gitgalaxy/tools/network_auditing/full_api_network_map.py` -> **Severity: 559.007** (Blast Radius: 6.053 * Doc Risk: 92.352%)
