...
| **Timestamp** | `2026-08-01T00:15:12.639023+00:00` |
| **Scan Duration** | `7.12s` |
| **Git Branch** | `main` |
| **Git Commit** | `52536bde2d4201fe8621cba0dd5bea59a6848bb0` |
...
| % Scanned of codebase = | 28.1% |
| Dominant Lang | PYTHON |

## 3.5 MACRO-NETWORK TOPOLOGY (Resilience & Coupling)
| Metric | Value | Interpretation |
|---|---|---|
| Modularity | 0.6566 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
| Assortativity | -0.2542 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
| Cyclic Density | 0.0% | % of files trapped in dependency loops (Static Friction). |
| Avg Path Length | 2.8882 | Hops between files. Lower = Tighter coupling. |
| Articulation Pts | 36 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| PYTHON | 150 | 52587 | 80.6% |
| MARKDOWN | 25 | 0 | 13.4% |
| YAML | 8 | 481 | 4.3% |
| PLAINTEXT | 3 | 0 | 1.6% |
...
> **Architectural Drift Z-Score:** `4.898`
...
|---|---|---|
| file_cluster_8 | 105 | 56.5% |
| file_cluster_13 | 30 | 16.1% |
| file_cluster_0 | 16 | 8.6% |
...
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 28 | 15.1% |
...
| Error & Exception Exposure | 0.0 | 76.6 | 6.0 | 0.0 | 0.0 |
...
| Instability Exposure | 0.0 | 32.8 | 1.3 | 0.0 | 0.0 |
| Volatility Exposure | 0.0 | 92.3 | 8.9 | 0.0 | 0.0 |
| Documentation Exposure | 0.0 | 100.0 | 4.7 | 0.0 | 0.0 |
| Algorithmic DoS Exposure | 0.0 | 100.0 | 10.5 | 0.0 | 0.0 |
...
1. **language_standards.py** (`gitgalaxy/standards/language_standards.py`) — 34 inbound connections
2. **_extraction_harness.py** (`tests/extraction/_extraction_harness.py`) — 17 inbound connections
...
| `gitgalaxy/standards` | 8 | 2060.1 | 8.11% | 18.59% |
| `tests/extraction` | 7 | 1868.28 | 3.7% | 0.0% |
| `tests/security_auditing` | 16 | 1694.36 | 2.0% | 0.0% |
| `tests/extraction/languages` | 17 | 1562.58 | 2.32% | 0.0% |
...
- **Unknown Dependencies:** `1020` packages imported that bypass the Zero-Trust whitelist.

## 11. CUMULATIVE RISK HITLIST (Top 10 Highest Risk Files)
> Cumulative Risk is the sum of all individual risk exposures. These files represent the highest multi-dimensional technical debt and architectural fragility.

### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **750.13**
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **684.89**
...
### 3. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **672.45**
- **Archetype:** `file_cluster_8` (Distance: 12.542 IQR)
- **Magnitude:** 3862.46 | **LOC:** 3044 | **CtrlFlow:** 71.1% | **Authorship Centralization:** 63.6%
- **Primary Risk Drivers:** Spec Match (100.0%), Algorithmic Dos (100.0%), Logic Bomb (100.0%), Churn (92.33%)
...
### 5. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **662.35**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **654.27**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **648.38**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **642.13**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` mypackage.MyClass, java.util.List, my.module, multiprocessing, Yesod, os, numpy, streamlit...
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 7.211
  * `Choke Point (Betweenness):` 0.002526 | `Ripple Effect (Closeness):` 0.016216
  * `Imports (Out-Degree: 30):` yaml, DAG, gitgalaxy.metrics.chronometer, gitgalaxy.tools.network_auditing.full_api_network_map, gitgalaxy.standards.analysis_lens, gitgalaxy.recorders.llm_recorder, gitgalaxy.core.network_risk_sensor, gitgalaxy.recorders.sarif_recorder...
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 9.211
  * `Choke Point (Betweenness):` 5.4e-05 | `Ripple Effect (Closeness):` 0.026486
  * `Imports (Out-Degree: 1):` pathlib, gitgalaxy.standards.analysis_lens, networkx, math, token, warnings, logging, collections...
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 9.221
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.03145
  * `Imports (Out-Degree: 0):` statistics, gitgalaxy.standards, math, os, logging, re, typing
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 6.903
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.016892
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, gitgalaxy.standards.gitgalaxy_config, time, math, gitgalaxy.standards.language_standards, logging, re, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 5.466
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.021622
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 5.21
  * `Choke Point (Betweenness):` 0.000127 | `Ripple Effect (Closeness):` 0.021622
  * `Imports (Out-Degree: 3):` gitgalaxy.core.spatial_correlation, gitgalaxy.standards.analysis_lens, time, tiktoken, bisect, math, gitgalaxy.standards.language_standards, logging...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 6.903
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.016892
  * `Imports (Out-Degree: 0):` pathlib, statistics, gitgalaxy.standards, heapq, sqlite3, json, logging, collections...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` yaml, gitgalaxy.standards.analysis_lens, or, os, subprocess, concurrent.futures, gitgalaxy.galaxyscope, failure...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `tests/extraction/test_dependency_extraction_strict.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 783.6 | **LOC:** 272 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` UIKit, signatures, qualified, network, formatting, mypack.myclass, gitgalaxy.standards.language_standards, machine...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, os, json, logging, re, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 6.903
  * `Choke Point (Betweenness):` 2.9e-05 | `Ripple Effect (Closeness):` 0.016892
  * `Imports (Out-Degree: 1):` pathlib, shutil, gitgalaxy.standards, time, os, gitgalaxy.standards.config_resolver, logging, subprocess...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.core.detector, gitgalaxy.standards.gitgalaxy_config, with, math, unittest.mock, gitgalaxy.core.spatial_mapper, gitgalaxy.standards.language_standards, logging...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, xgboost, gitgalaxy.standards.analysis_lens, networkx, pandas, numpy, logging, collections...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, sys, _extraction_harness, java.util.List, only, typing, com.example.MyClass, java.util....
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, sys, json, ast, argparse, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 357.02 | **LOC:** 12536 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` scala.util.chaining., type, scala.util., path, was, java.util., form, inside...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` yaml, dataclasses, gitgalaxy.standards, copy, __future__, logging, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.recorders.sarif_recorder, which, identity, os, json, tempfile, gitgalaxy.metrics.signal_processor, pytest
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` yaml, pathlib, sys, bypassed, multiprocessing, unittest.mock, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, json...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.621
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` org.slf4j.Logger, pathlib, sys, shutil, gitgalaxy.tools.cobol_to_java.cobol_to_java_spring_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_service_forge, org.slf4j.LoggerFactory, gitgalaxy.tools.cobol_to_java.cobol_to_java_decoder_forge...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 8.441
  * `Choke Point (Betweenness):` 0.000235 | `Ripple Effect (Closeness):` 0.021622
  * `Imports (Out-Degree: 4):` pathlib, uuid, gitgalaxy.standards.gitgalaxy_config, gitgalaxy.security.security_lens, os, gitgalaxy.standards.language_lens, json, gitgalaxy.standards.language_standards...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **69.79%** | Cog Load: 62.8023% | Debt: 0.0%
...
- `gitgalaxy/galaxyscope.py` -> **Severity: 0.196** (Bridge: 0.0025 * Flux: 77.6198%)
- `gitgalaxy/cobol_refractor_controller.py` -> **Severity: 0.026** (Bridge: 0.0003 * Flux: 97.0538%)
- `gitgalaxy/recorders/sbom_recorder.py` -> **Severity: 0.023** (Bridge: 0.0002 * Flux: 97.0328%)
...
- `gitgalaxy/standards/config_resolver.py` -> **Severity: 4.633** (Embedded: 0.0579 * Error Risk: 80.0%)
- `gitgalaxy/core/network_risk_sensor.py` -> **Severity: 1.928** (Embedded: 0.0265 * Error Risk: 72.8082%)
- `gitgalaxy/recorders/sarif_recorder.py` -> **Severity: 1.365** (Embedded: 0.0216 * Error Risk: 63.1492%)
- `gitgalaxy/tools/ai_guardrails/ai_appsec_sensor.py` -> **Severity: 1.351** (Embedded: 0.0169 * Error Risk: 80.0%)
- `gitgalaxy/recorders/llm_recorder.py` -> **Severity: 1.294** (Embedded: 0.0169 * Error Risk: 76.6083%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `gitgalaxy/standards/config_resolver.py` -> **Severity: 2838.9** (Blast Radius: 28.389 * Doc Risk: 100.0%)
- `gitgalaxy/standards/language_standards.py` -> **Severity: 1207.58** (Blast Radius: 70.793 * Doc Risk: 17.0579%)
- `gitgalaxy/metrics/tensor_scanner.py` -> **Severity: 690.3** (Blast Radius: 6.903 * Doc Risk: 100.0%)
- `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` -> **Severity: 669.8** (Blast Radius: 6.698 * Doc Risk: 100.0%)
- `gitgalaxy/tools/network_auditing/full_api_network_map.py` -> **Severity: 637.506** (Blast Radius: 6.903 * Doc Risk: 92.352%)
