...
| **Timestamp** | `2026-08-27T14:56:28.415197+00:00` |
| **Scan Duration** | `9.77s` |
| **Git Branch** | `main` |
| **Git Commit** | `7b0e165f9703c607563797dfb0b346c7f0ee2bd6` |
...
|---|---|---|
| Modularity | 0.7409 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
| Assortativity | -0.3517 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
| Cyclic Density | 0.0% | % of files trapped in dependency loops (Static Friction). |
| Avg Path Length | 4.2521 | Hops between files. Lower = Tighter coupling. |
| Articulation Pts | 45 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| PYTHON | 241 | 60438 | 85.8% |
| MARKDOWN | 28 | 0 | 10.0% |
| YAML | 8 | 494 | 2.8% |
| PLAINTEXT | 3 | 0 | 1.1% |
| SHELL | 1 | 22 | 0.4% |
...
| Instability Exposure | 0.0 | 16.4 | 0.7 | 0.0 | 0.0 |
...
- `_slice_by_braces` (@ `gitgalaxy/core/detector.py`) -> Impact: **938.5** | LOC: 1097
...
- `_calculate_block_metrics` (@ `gitgalaxy/core/detector.py`) -> Impact: **314.3** | LOC: 445
...
|---|---|---|---|---|
| `tests/extraction/languages` | 92 | 6707.88 | 3.43% | 0.0% |
| `gitgalaxy/core` | 9 | 5044.9 | 14.34% | 7.89% |
| `gitgalaxy/recorders` | 8 | 2563.28 | 23.46% | 3.12% |
| `tests/core_engine` | 22 | 2543.76 | 3.07% | 0.0% |
| `gitgalaxy/metrics` | 5 | 1635.36 | 16.5% | 4.56% |
| `gitgalaxy` | 6 | 1528.5 | 8.79% | 0.0% |
| `gitgalaxy/standards` | 7 | 1170.36 | 5.26% | 6.81% |
| `tests/security_auditing` | 15 | 965.32 | 1.99% | 0.0% |
...
- `gitgalaxy/core/detector.py` -> **30.3851%** Exposure
...
- `gitgalaxy/core/prism.py` -> **99.9516%** Exposure
...
- **Unknown Dependencies:** `1625` packages imported that bypass the Zero-Trust whitelist.
...
### 2. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **500.86**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 3. `gitgalaxy/core/detector.py` (PYTHON) -> Cumulative Risk: **490.91**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 4. `gitgalaxy/recorders/gpu_recorder.py` (PYTHON) -> Cumulative Risk: **471.72**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 6. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **443.18**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 258.9 | **LOC:** 561 | **CtrlFlow:** 71.8% | **Authorship Centralization:** 66.7%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.0485%), Safety Score (80.3619%), Verification (80.0%)
- **Heaviest Functions:** `audit` (Impact: 150.6), `__init__` (Impact: 10.7), `_is_dead_code` (Impact: 9.7)

### 7. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **432.47**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1266.62 | **LOC:** 3099 | **CtrlFlow:** 71.3% | **Authorship Centralization:** 100.0%
...
### 8. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **412.95**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 9. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **410.98**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 10. `gitgalaxy/metrics/signal_processor.py` (PYTHON) -> Cumulative Risk: **407.93**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Magnitude:** 3599.24 | **LOC:** 5728 | **CtrlFlow:** 76.7% | **Authorship Centralization:** 92.8%
- **Risk Profile:** Cognitive Load (19.9034%), Tech Debt (30.3851%)
**Top Internal Functions/Classes:**
  * `_slice_by_braces` (Impact: 938.5)
  * `_calculate_block_metrics` (Impact: 314.3)
  * `splice` (Impact: 240.5)
...
* *Structure:* `branch: 1192`, `structural_boundaries: 362`, `args: 55`, `func_start: 53`, `class_start: 6`
* *Risk/State:* `safety_bypasses: 77`, `state_mutation: 201`, `dead_code: 32`, `planned_debt: 1`, `fragile_debt: 19`, `duplicate_logic: 2`
* *Architecture:* `api: 19`, `concurrency: 2`, `import: 14`
* *Defense:* `safety: 47`, `doc: 116`, `test: 2`, `immutability_locks: 8`
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 17.038
  * `Choke Point (Betweenness):` 0.000401 | `Ripple Effect (Closeness):` 0.062112
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 4.252
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.011161
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1266.62 | **LOC:** 3099 | **CtrlFlow:** 71.3% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (21.881%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  ...
  * `_process_file_worker` (Impact: 144.1)
...
* *Sec High Risk Execution:* 1 instances
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 543`, `structural_boundaries: 219`, `args: 33`, `func_start: 23`, `class_start: 1`
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 4.438
  * `Choke Point (Betweenness):` 0.001062 | `Ripple Effect (Closeness):` 0.010714
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 7.575
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.024107
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 731.96 | **LOC:** 1157 | **CtrlFlow:** 67.0% | **Authorship Centralization:** 92.9%
- **Risk Profile:** Cognitive Load (29.2557%), Tech Debt (30.1101%)
**Top Internal Functions/Classes:**
  * `_strip_single_line_comments` (Impact: 123.7)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 10.566
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.030867
...
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 648.14 | **LOC:** 3457 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 501.64 | **LOC:** 2103 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` concurrent.futures, failure, gitgalaxy.core.aperture, gitgalaxy.galaxyscope, gitgalaxy.standards, gitgalaxy.standards.analysis_lens, logging, must...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 258.9 | **LOC:** 561 | **CtrlFlow:** 71.8% | **Authorship Centralization:** 66.7%
- **Risk Profile:** Cognitive Load (37.8042%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `audit` (Impact: 150.6)
...
* *Sec High Risk Execution:* 1 instances
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 89`, `structural_boundaries: 35`, `args: 8`, `func_start: 6`, `class_start: 1`
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 4.252
  * `Choke Point (Betweenness):` 1.3e-05 | `Ripple Effect (Closeness):` 0.011161
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 4.726
  * `Choke Point (Betweenness):` 1.7e-05 | `Ripple Effect (Closeness):` 0.014286
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 4.252
  * `Choke Point (Betweenness):` 6.4e-05 | `Ripple Effect (Closeness):` 0.014286
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 4.122
  * `Choke Point (Betweenness):` 0.000115 | `Ripple Effect (Closeness):` 0.003571
...
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 169.38 | **LOC:** 642 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `assert_linear_redos_scaling` (Impact: 10.9)
...
- `gitgalaxy/core/detector.py` -> **Joe Esquibel** (92.8% isolated ownership) | Magnitude: 3599.24
- `gitgalaxy/recorders/llm_recorder.py` -> **Joe Esquibel** (87.5% isolated ownership) | Magnitude: 1564.86
- `gitgalaxy/galaxyscope.py` -> **Joe Esquibel** (100.0% isolated ownership) | Magnitude: 1266.62
- `gitgalaxy/metrics/signal_processor.py` -> **Joe Esquibel** (81.8% isolated ownership) | Magnitude: 1098.92
- `gitgalaxy/core/prism.py` -> **Joe Esquibel** (92.9% isolated ownership) | Magnitude: 731.96
...
- `gitgalaxy/core/detector.py` -> **Severity: 0.023** (Bridge: 0.0004 * Flux: 56.5717%)
...
- `gitgalaxy/core/detector.py` -> **Severity: 3.77** (Embedded: 0.0621 * Error Risk: 60.6928%)
- `gitgalaxy/core/spatial_correlation.py` -> **Severity: 2.74** (Embedded: 0.0468 * Error Risk: 58.6062%)
...
- `gitgalaxy/standards/config_resolver.py` -> **Severity: 1.788** (Embedded: 0.0383 * Error Risk: 46.7319%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `gitgalaxy/standards/analysis_lens.py` -> **Severity: 448.262** (Blast Radius: 25.07 * Doc Risk: 17.8804%)
- `gitgalaxy/standards/config_resolver.py` -> **Severity: 369.105** (Blast Radius: 20.643 * Doc Risk: 17.8804%)
- `gitgalaxy/core/detector.py` -> **Severity: 297.335** (Blast Radius: 17.038 * Doc Risk: 17.4513%)
- `gitgalaxy/standards/gitgalaxy_config.py` -> **Severity: 290.288** (Blast Radius: 16.235 * Doc Risk: 17.8804%)
- `scripts/update_golden_masters.sh` -> **Severity: 198.549** (Blast Radius: 2.228 * Doc Risk: 89.1154%)
