...
| **Timestamp** | `2026-08-22T17:47:24.503111+00:00` |
| **Scan Duration** | `9.51s` |
| **Git Branch** | `main` |
| **Git Commit** | `3969af26621302983d4261f4ff024b7d9043152d` |
...
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 551 |
| Total LOC | 59691 |
...
*Total Excluded Artifacts: 551*

**Composition by Extension & Reason:**
- `.md`: 372x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 1x Excluded (Machine-Generated Source Code Signature: 58 LOC), 1x Excluded (Machine-Generated Source Code Signature: 41 LOC)
...
| Instability Exposure | 0.0 | 13.7 | 0.6 | 0.0 | 0.0 |
...
- `_cpp_class_has_body` (@ `gitgalaxy/core/detector.py`) -> Impact: **1306.3** | LOC: 2777
...
| `gitgalaxy/core` | 9 | 2579.48 | 15.55% | 6.57% |
...
- `gitgalaxy/core/detector.py` -> **18.6395%** Exposure
...
### 1. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **499.59**
...
### 2. `gitgalaxy/core/detector.py` (PYTHON) -> Cumulative Risk: **481.86**
- **Archetype:** `file_cluster_8` (Distance: 12.798 IQR)
- **Magnitude:** 1601.36 | **LOC:** 5381 | **CtrlFlow:** 75.7% | **Authorship Centralization:** 91.6%
- **Primary Risk Drivers:** Spec Match (100.0%), Churn (100.0%), Verification (80.0%), Safety Score (59.6577%)
- **Heaviest Functions:** `_cpp_class_has_body` (Impact: 1306.3), `_classify_function` (Impact: 46.8), `get_token_mass` (Impact: 6.4)

### 3. `gitgalaxy/recorders/llm_recorder.py` (PYTHON) -> Cumulative Risk: **456.42**
- **Archetype:** `file_cluster_8` (Distance: 13.24 IQR)
...
### 6. `gitgalaxy/metrics/signal_processor.py` (PYTHON) -> Cumulative Risk: **423.43**
...
### 7. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **422.7**
...
### 8. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **409.44**
...
### 9. `gitgalaxy/recorders/gpu_recorder.py` (PYTHON) -> Cumulative Risk: **394.27**
...
### 10. `gitgalaxy/core/network_risk_sensor.py` (PYTHON) -> Cumulative Risk: **391.46**
- **Archetype:** `file_cluster_13` (Distance: 10.994 IQR)
...
- **Local Micro-Species:** `Cluster 1: Declarative Glue & Initialization` (Drift: 4.288 IQR)
- **Top Global Matches:** file_cluster_8: 12.798, file_cluster_16: 12.975, file_cluster_13: 13.001
- **Magnitude:** 1601.36 | **LOC:** 5381 | **CtrlFlow:** 75.7% | **Authorship Centralization:** 91.6%
- **Risk Profile:** Cognitive Load (29.6029%), Tech Debt (18.6395%)
**Top Internal Functions/Classes:**
  * `_cpp_class_has_body` (Impact: 1306.3)
...
* *Structure:* `branch: 1010`, `structural_boundaries: 325`, `args: 44`, `func_start: 43`, `class_start: 6`
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 2):` gitgalaxy.core.spatial_correlation, tiktoken, gitgalaxy.standards.language_standards, bisect, collections, time, re, gitgalaxy.standards.analysis_lens...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 29):` gitgalaxy.tools.ai_guardrails.dev_agent_firewall, gitgalaxy.security.dependency_audit_cache, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, gitgalaxy.metrics.statistical_auditor, multiprocessing, sys, gitgalaxy.recorders.llm_recorder, DAG...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, _strict_harness, gitgalaxy.standards.language_standards, sys, pytest, re
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Global Archetype:** `file_cluster_8` (Drift: 13.24 IQR)
- **Local Micro-Species:** `Cluster 1: Declarative Glue & Initialization` (Drift: 4.146 IQR)
- **Top Global Matches:** file_cluster_8: 13.24, file_cluster_13: 13.49, file_cluster_17: 13.494
- **Magnitude:** 753.72 | **LOC:** 1407 | **CtrlFlow:** 85.9% | **Authorship Centralization:** 87.5%
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` pathlib, json, collections, gitgalaxy.standards, sqlite3, logging, typing, heapq...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.core.prism, gitgalaxy.standards.language_standards, pytest, re, unittest.mock, gitgalaxy.core.detector, gitgalaxy.standards.gitgalaxy_config, gitgalaxy.core.spatial_mapper...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, only, gitgalaxy.standards.language_standards, sys, pytest, typing, _extraction_harness
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, _strict_harness, gitgalaxy.standards.language_standards, sys, pytest, this, and
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, os, json, re, typing, logging
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.galaxyscope, sys, re, subprocess, concurrent.futures, gitgalaxy.standards.analysis_lens, gitgalaxy.standards, passes...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, only, gitgalaxy.standards.language_standards, sys, pytest, java.util.List, com.example.MyClass, static...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` os, math, re, gitgalaxy.standards, logging, typing, statistics
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, gitgalaxy.standards.language_standards, contextlib, time, re, gitgalaxy.standards.gitgalaxy_config, typing, math...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` os, which, json, pytest, gitgalaxy.metrics.signal_processor, identity, gitgalaxy.recorders.sarif_recorder, tempfile...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/core/network_risk_sensor.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_13` (Drift: 10.994 IQR)
- **Local Micro-Species:** `Cluster 1: Declarative Glue & Initialization` (Drift: 4.802 IQR)
- **Top Global Matches:** file_cluster_13: 10.994, file_cluster_8: 11.092, file_cluster_17: 11.108
- **Magnitude:** 260.22 | **LOC:** 442 | **CtrlFlow:** 68.1% | **Authorship Centralization:** 66.7%
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` pathlib, math, networkx.algorithms, collections, networkx, gitgalaxy.standards.analysis_lens, token, warnings...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, numpy, pandas, collections, networkx, gitgalaxy.standards.analysis_lens, xgboost, typing...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, _strict_harness, gitgalaxy.standards.language_standards, sys, pytest, re, shapes, multiprocessing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `gitgalaxy/core/detector.py` -> **Joe Esquibel** (91.6% isolated ownership) | Magnitude: 1601.36
...
- `gitgalaxy/core/detector.py` -> **Severity: 0.017** (Bridge: 0.0003 * Flux: 51.2842%)
...
- `gitgalaxy/core/detector.py` -> **Severity: 3.09** (Embedded: 0.0518 * Error Risk: 59.6577%)
...
- `gitgalaxy/core/detector.py` -> **Severity: 247.853** (Blast Radius: 14.261 * Doc Risk: 17.3798%)
