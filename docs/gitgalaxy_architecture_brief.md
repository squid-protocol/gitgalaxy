...
| **File Archetype Brain** | corpus `unrecorded` @ `unrecorded` · trainer `unrecorded` · engine `1fb648d8` · contract `92c0b8a801d69bb0` · trained `unrecorded` |
| **Repo Archetype Brain** | corpus `unrecorded` @ `unrecorded` · trainer `unrecorded` · engine `1fb648d8` · contract `5858e2d9914677a1` · trained `unrecorded` |
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 431 analyzed artifact(s), 92300 LOC.
- **Load-bearing artifact:** `gitgalaxy/standards/language_standards/languages/json.py` -- 68 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `gitgalaxy/galaxyscope.py` -- pulls in 60 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `gitgalaxy/core/detector.py` at magnitude 8443.72 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 431 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 623 |
| Total LOC | 92300 |
| Volatility Index | 0.002 |
| % Scanned of codebase = | 40.9% |
| Dominant Lang | PYTHON |

## 3.5 MACRO-NETWORK TOPOLOGY (Resilience & Coupling)
| Metric | Value | Interpretation |
|---|---|---|
| Modularity | 0.6675 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
| Assortativity | -0.299 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
| Cyclic Density | 0.0% | % of files trapped in dependency loops (Static Friction). |
| Avg Path Length | 1.8201 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
| Articulation Pts | 46 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| PYTHON | 387 | 91207 | 89.8% |
| MARKDOWN | 28 | 0 | 6.5% |
| YAML | 11 | 1009 | 2.6% |
| PLAINTEXT | 3 | 0 | 0.7% |
| SHELL | 2 | 84 | 0.5% |
...
> **Architectural Drift Z-Score:** `0.76`
> **Composition Archetype:** `Hub-Coupled App` (z +0.76; from the repo's file-archetype mix)
> **File Composition:** Defensive Guards Files 28%, Declarative / Non-Code 17%, Large Core Modules 16%, Data / Markup / Trivial 12%, Tests & Verification Files 8%
...
|---|---|---|
| Unclassified | 400 | 92.8% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 31 | 7.2% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 623*

**Composition by Extension & Reason:**
- `.md`: 431x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 1x Excluded (Machine-Generated Source Code Signature: 58 LOC), 1x Excluded (Machine-Generated Source Code Signature: 41 LOC)
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 65.1 | 0.7 | 0.0 | 0.0 |
...
| Dead Code Surface (formerly Commented Logic Exposure) | 0.0 | 11.5 | 0.1 | 0.0 | 0.0 |
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 16.1 | 0.2 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 2.5 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 50.0 | 1.4 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 372 | 22 | 0 | `gitgalaxy/recorders/record_keeper.py` |
| cleanup | 16 | 7 | 0 | `gitgalaxy/galaxyscope.py` |
| guards | 600 | 25 | 0 | `gitgalaxy/core/detector.py` |
| danger | 592 | 24 | 0 | `gitgalaxy/core/detector.py` |
...
| serialization | 0 | 0 | 0 | - |
| regex | 167 | 9 | 0 | `gitgalaxy/core/detector.py` |
| events | 258 | 18 | 0 | `gitgalaxy/galaxyscope.py` |
| tests | 5 | 3 | 0 | `.claude/hooks/pytest_quiet.py` |
| docs | 382 | 28 | 0 | `gitgalaxy/core/detector.py` |
| debt | 158 | 17 | 0 | `gitgalaxy/core/detector.py` |
| mutation | 8972 | 27 | 0 | `gitgalaxy/core/detector.py` |
...
1. **json.py** (`gitgalaxy/standards/language_standards/languages/json.py`) — 68 inbound connections
...
4. **detector.py** (`gitgalaxy/core/detector.py`) — 47 inbound connections
...
- `splice` **(Many-Argument Workhorses)** (@ `gitgalaxy/core/detector.py`) -> Impact: **450.6** | LOC: 809
...
| `gitgalaxy/core` | 11 | 13125.1 | 36.52% | 12.49% |
| `tests/core_engine` | 43 | 7682.2 | 13.51% | 0.0% |
| `gitgalaxy/recorders` | 8 | 4841.88 | 47.2% | 4.22% |
| `gitgalaxy/metrics` | 7 | 3498.68 | 45.58% | 14.15% |
| `gitgalaxy` | 6 | 3172.56 | 32.68% | 0.0% |
| `gitgalaxy/standards` | 9 | 2028.42 | 12.46% | 6.31% |
| `tests/security_auditing` | 15 | 1789.56 | 12.11% | 0.0% |
| `gitgalaxy/security` | 7 | 1649.56 | 38.17% | 2.03% |
| `gitgalaxy/standards/language_standards/languages` | 64 | 1409.2 | 5.92% | 63.38% |
...
- `gitgalaxy/core/detector.py` -> **26.8872%** Exposure
...
- **Unknown Dependencies:** `2523` packages imported that bypass the Zero-Trust whitelist.
...
- **Magnitude:** 8443.72 | **LOC:** 8851 | **CtrlFlow:** 40.9% | **Authorship Centralization:** 100.0%
- **Blast Radius:** changing it is visible to **47** in-repo importer(s); it depends on **17**; blast radius 24.001; role: Pure Producer (Foundation)
...
- **Documentation Coverage:** 21.8447% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_slice_by_braces` **(Many-Argument Workhorses)** (Impact: 1155.8)
  * `splice` **(Many-Argument Workhorses)** (Impact: 450.6)
...
* *Amplified Cascading Flux:* 1146 instances
* *Concurrency (weighted view):* 7
* *State Mutation (weighted view):* 3618
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 1738`, `structural_boundaries: 535`, `args: 89`, `func_start: 85`, `class_start: 6`
* *Risk/State:* `safety_bypasses: 101`, `state_mutation: 1326`, `dead_code: 56`, `planned_debt: 2`, `fragile_debt: 24`, `duplicate_logic: 2`
* *Architecture:* `api: 19`, `concurrency: 2`, `import: 18`
* *Defense:* `safety: 38`, `doc: 83`, `immutability_locks: 34`
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 24.001
  * `Choke Point (Betweenness):` 0.001737 | `Ripple Effect (Closeness):` 0.104527
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **60**; blast radius 4.26; role: Transceiver (Middle-Tier)
...
**Top Internal Functions/Classes:**
  ...
  * `main` **(Compute Cores)** (Impact: 102.9)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001484 | `Ripple Effect (Closeness):` 0.018837
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **12**; blast radius 2.759; role: Transceiver (Middle-Tier)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 2.759
  * `Choke Point (Betweenness):` 1e-05 | `Ripple Effect (Closeness):` 0.017088
...
- **Blast Radius:** changing it is visible to **13** in-repo importer(s); it depends on **12**; blast radius 7.706; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (73.1%)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 7.706
  * `Choke Point (Betweenness):` 0.000167 | `Ripple Effect (Closeness):` 0.03229
...
- **Blast Radius:** changing it is visible to **21** in-repo importer(s); it depends on **4**; blast radius 10.037; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (67.1%)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 10.037
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.055056
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **13**; blast radius 8.119; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (42.2%)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.119
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.057627
...
- **Global Archetype:** `file_cluster_11` (Drift: 0.0 IQR)
- **Magnitude:** 814.92 | **LOC:** 1680 | **CtrlFlow:** 27.5% | **Authorship Centralization:** 100.0%
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **13**; blast radius 5.65; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (71.6%)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 249`, `structural_boundaries: 48`, `args: 8`, `func_start: 8`, `class_start: 2`
* *Risk/State:* `safety_bypasses: 22`, `state_mutation: 254`, `dead_code: 2`, `fragile_debt: 1`
* *Architecture:* `io: 1`, `api: 4`, `import: 8`
* *Defense:* `safety: 24`, `doc: 22`, `immutability_locks: 1`, `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 5.65
  * `Choke Point (Betweenness):` 4e-05 | `Ripple Effect (Closeness):` 0.029983
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **8**; blast radius 1.883; role: Transceiver (Middle-Tier)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 1.883
  * `Choke Point (Betweenness):` 2e-06 | `Ripple Effect (Closeness):` 0.0134
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **5**; blast radius 2.408; role: Transceiver (Middle-Tier)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 2.408
  * `Choke Point (Betweenness):` 5e-06 | `Ripple Effect (Closeness):` 0.0134
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **16**; blast radius 9.414; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (55.7%), Complexity Load (formerly Cognitive Load) (38.9%)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 9.414
  * `Choke Point (Betweenness):` 0.000355 | `Ripple Effect (Closeness):` 0.075823
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **7**; blast radius 8.472; role: Pure Producer (Foundation)
...
**Top Internal Functions/Classes:**
  ...
  * `_walk_seq` **(Many-Argument Workhorses)** (Impact: 47.3)
  ...
  * `_in_set_can_match_nl` **(Compute Cores)** (Impact: 16.7)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.472
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.068771
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **8**; blast radius 2.233; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Complexity Load (formerly Cognitive Load) (36.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.1%)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 2.233
  * `Choke Point (Betweenness):` 1.3e-05 | `Ripple Effect (Closeness):` 0.015222
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **7**; blast radius 2.408; role: Transceiver (Middle-Tier)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 2.408
  * `Choke Point (Betweenness):` 2.4e-05 | `Ripple Effect (Closeness):` 0.0134
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **9**; blast radius 3.46; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (48.0%)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 3.46
  * `Choke Point (Betweenness):` 3.3e-05 | `Ripple Effect (Closeness):` 0.015222
...
- `gitgalaxy/core/detector.py` -> Churn: **100.0%** | Cog Load: 68.0675% | Debt: 26.8872%
- `gitgalaxy/galaxyscope.py` -> Churn: **79.55%** | Cog Load: 84.3126% | Debt: 0.0%
- `gitgalaxy/metrics/signal_processor.py` -> Churn: **73.12%** | Cog Load: 63.6064% | Debt: 8.9543%
- `gitgalaxy/recorders/record_keeper.py` -> Churn: **71.57%** | Cog Load: 56.7984% | Debt: 9.2856%
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **63.94%** | Cog Load: 81.2685% | Debt: 10.0746%

### 👤 Key Person Dependencies (High Impact + Siloed Knowledge)
These are massive, load-bearing files written almost entirely by a single developer. They represent severe 'Bus Factor' risk.

- `gitgalaxy/core/detector.py` -> **Joe Esquibel** (100.0% isolated ownership) | Magnitude: 8443.72
...
- `gitgalaxy/core/detector.py` -> **Severity: 0.174** (Bridge: 0.0017 * Flux: 100.0%)
- `gitgalaxy/galaxyscope.py` -> **Severity: 0.148** (Bridge: 0.0015 * Flux: 100.0%)
...
- `gitgalaxy/standards/language_standards/languages/json.py` -> **Severity: 13.496** (Embedded: 0.1922 * Error Risk: 70.2063%)
- `tests/extraction/languages/_strict_harness.py` -> **Severity: 12.477** (Embedded: 0.1488 * Error Risk: 83.8311%)
- `gitgalaxy/core/detector.py` -> **Severity: 10.405** (Embedded: 0.1045 * Error Risk: 99.5431%)
- `gitgalaxy/standards/language_standards/_shared_patterns.py` -> **Severity: 9.278** (Embedded: 0.1103 * Error Risk: 84.1131%)
- `gitgalaxy/core/spatial_correlation.py` -> **Severity: 8.373** (Embedded: 0.0907 * Error Risk: 92.3601%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `gitgalaxy/core/detector.py` -> **Severity: 524.295** (Blast Radius: 24.001 * Doc Risk: 21.8447%)
- `gitgalaxy/standards/config_resolver.py` -> **Severity: 487.616** (Blast Radius: 10.326 * Doc Risk: 47.2222%)
- `tests/tools/fidelity_table.py` -> **Severity: 426.3** (Blast Radius: 5.684 * Doc Risk: 75.0%)
- `tests/tools/tri_comparison_reconcile.py` -> **Severity: 387.44** (Blast Radius: 4.843 * Doc Risk: 80.0%)
- `gitgalaxy/core/spatial_correlation.py` -> **Severity: 377.3** (Blast Radius: 15.092 * Doc Risk: 25.0%)
