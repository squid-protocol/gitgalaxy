...
| **Timestamp** | `2026-07-26T17:44:42.951182+00:00` |
| **Scan Duration** | `5.84s` |
| **Git Branch** | `main` |
| **Git Commit** | `0c60f2168606355a753d58481253fbc36d3f72f8` |
...
> **Architectural Drift Z-Score:** `5.293`
...
|---|---|---|
| file_cluster_8 | 99 | 61.5% |
| file_cluster_13 | 25 | 15.5% |
...
| Instability Exposure | 0.0 | 30.1 | 0.8 | 0.0 | 0.0 |
...
5. **test_language_standards_strict.py** (`tests/core_engine/test_language_standards_strict.py`) — 16 outbound dependencies
...
| `tests/core_engine` | 17 | 2984.1 | 2.8% | 0.0% |
| `gitgalaxy/standards` | 8 | 2052.42 | 8.02% | 12.6% |
...
### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **750.97**
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **685.13**
...
### 3. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **676.16**
...
### 4. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **662.93**
...
### 5. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **661.1**
...
### 6. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **660.28**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **653.25**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **646.95**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **642.98**
...
### 10. `gitgalaxy/recorders/sarif_recorder.py` (PYTHON) -> Cumulative Risk: **636.97**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 30):` gitgalaxy.recorders.record_keeper, gitgalaxy.security.dependency_audit_cache, gitgalaxy.standards.language_standards, importlib.util, gitgalaxy.core.aperture, gitgalaxy.recorders.sarif_recorder, gitgalaxy.recorders.audit_recorder, gitgalaxy.tools.ai_guardrails.ai_appsec_sensor...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` pathlib, networkx.algorithms, logging, networkx, warnings, gitgalaxy.standards.analysis_lens, collections, math...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` re, gitgalaxy.standards, logging, os, math, statistics, typing
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` re, pathlib, gitgalaxy.standards.language_standards, logging, gitgalaxy.standards.gitgalaxy_config, time, math, typing
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` machine, gitgalaxy.standards.language_standards, static, fmt, os, formatting, pytest, signatures...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 3):` re, gitgalaxy.standards.language_standards, gitgalaxy.core.spatial_correlation, logging, bisect, gitgalaxy.standards.analysis_lens, time, collections...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.108
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.019531
  * `Imports (Out-Degree: 0):` heapq, pathlib, gitgalaxy.standards, logging, sqlite3, collections, statistics, json...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.core.aperture, passes, os, re, pathlib, name, sys, gitgalaxy.standards.analysis_lens...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` pathlib, gitgalaxy.standards, typing, logging, time, os, shutil, gitgalaxy.standards.config_resolver...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pandas, pathlib, xgboost, logging, networkx, gitgalaxy.standards.analysis_lens, collections, numpy...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 9):` gitgalaxy.licensing, gitgalaxy.tools.cobol_to_cobol.cobol_schema_forge, argparse, pathlib, gitgalaxy.tools.cobol_to_cobol.cobol_microservice_slicer, datetime, gitgalaxy.tools.cobol_to_cobol.cobol_dag_architect, gitgalaxy.tools.cobol_to_cobol.cobol_jcl_forge...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.core.spatial_mapper, gitgalaxy.core.detector, re, with, logging, math, unittest.mock, pytest
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `tests/core_engine/test_language_standards_strict.py` (PYTHON | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 435.08 | **LOC:** 870 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_cpp_macro_multiline_spiral` (Impact: 264.3 | O(N^5) | DB: 19)
  * `test_haskell_signature_positive_and_nega` (Impact: 20.4 | O(N^3))
  * `test_haskell_globals_unsafeperformio_bug` (Impact: 16.2 | O(N^2) | DB: 1)
  * `assert_redos_immune` (Impact: 13.1 | O(N^3))
  * `test_haskell_func_start_excludes_type_le` (Impact: 7.4 | O(N^3))
    * *Intent:* # ============================================================================== # HASKELL: STRICT S...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
* *Architecture:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` re, gitgalaxy.standards.language_standards, multiprocessing, streamlit, os.path, Reactive.Banana, qualified, ccall...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, argparse, ast, sys, json, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.standards, logging, yaml, dataclasses, __future__, copy, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 352.64 | **LOC:** 10348 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` re, inside, type, java.util., keyword., path, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` tempfile, identity, gitgalaxy.recorders.sarif_recorder, which, os, gitgalaxy.metrics.signal_processor, json, pytest
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` gitgalaxy.licensing, gitgalaxy.tools.cobol_to_java.cobol_to_java_decoder_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_agent_forge, pathlib, argparse, org.springframework.stereotype.Service, org.slf4j.LoggerFactory, gitgalaxy.tools.cobol_to_java.cobol_to_java_service_forge...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 4):` pathlib, gitgalaxy.security.manifest_parser, gitgalaxy.security.security_lens, datetime, gitgalaxy.standards.language_standards, logging, gitgalaxy.standards.gitgalaxy_config, gitgalaxy.standards.language_lens...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, was, bypassed, sys, gitgalaxy.standards.config_resolver, unittest.mock, policy, gitgalaxy.tools.supply_chain_security.supply_chain_firewall...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 8.108
  * `Choke Point (Betweenness):` 3.9e-05 | `Ripple Effect (Closeness):` 0.019531
  * `Imports (Out-Degree: 1):` re, pathlib, logging, gitgalaxy.standards.gitgalaxy_config, os, fnmatch, json, typing
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
- `gitgalaxy/security/security_auditor.py` -> **Severity: 0.009** (Bridge: 0.0001 * Flux: 94.0786%)
...
- `gitgalaxy/core/network_risk_sensor.py` -> **Severity: 2.23** (Embedded: 0.0306 * Error Risk: 72.8082%)
...
- `gitgalaxy/recorders/llm_recorder.py` -> **Severity: 1.496** (Embedded: 0.0195 * Error Risk: 76.6083%)
...
- `gitgalaxy/tools/network_auditing/full_api_network_map.py` -> **Severity: 748.79** (Blast Radius: 8.108 * Doc Risk: 92.352%)
- `gitgalaxy/standards/language_standards.py` -> **Severity: 717.425** (Blast Radius: 47.785 * Doc Risk: 15.0136%)
