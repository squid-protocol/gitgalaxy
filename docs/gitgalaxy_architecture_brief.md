...
| **Timestamp** | `2026-08-26T10:05:37.162194+00:00` |
| **Scan Duration** | `10.23s` |
| **Git Branch** | `main` |
| **Git Commit** | `2382b89e1eaefb92f6e6b900849f726c3e9dc5dd` |
...
| Instability Exposure | 0.0 | 15.7 | 0.7 | 0.0 | 0.0 |
...
### 2. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **500.93**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 3. `gitgalaxy/core/detector.py` (PYTHON) -> Cumulative Risk: **488.57**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 8. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **412.65**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 10. `gitgalaxy/metrics/signal_processor.py` (PYTHON) -> Cumulative Risk: **409.0**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
