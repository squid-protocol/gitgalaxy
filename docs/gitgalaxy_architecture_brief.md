...
| **Timestamp** | `2026-07-30T16:27:57.639482+00:00` |
| **Scan Duration** | `7.67s` |
| **Git Branch** | `main` |
| **Git Commit** | `256207906799b2d4a6514c051abb78c17fd4be57` |
...
| Instability Exposure | 0.0 | 32.2 | 1.3 | 0.0 | 0.0 |
| Volatility Exposure | 0.0 | 98.3 | 10.9 | 0.0 | 0.0 |
...
- `assert_redos_immune` (@ `tests/core_engine/test_language_standards_strict.py`) -> Impact: **493.8** | LOC: 1278
...
### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **752.92**
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **687.2**
...
### 5. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **664.92**
...
### 6. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **663.38**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **655.59**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **651.5**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **644.92**
...
### 10. `gitgalaxy/recorders/sarif_recorder.py` (PYTHON) -> Cumulative Risk: **639.01**
...
- **Magnitude:** 4051.52 | **LOC:** 14008 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `assert_redos_immune` (Impact: 493.8 | O(2^N) | DB: 24)
  * `test_livecode_ambiguity_io_vs_ipc_rpc_br` (Impact: 396.6 | O(N^3) | DB: 8)
  * `f` (Impact: 362.8 | O(N^3) | DB: 60)
  * `assert_redos_immune` (Impact: 275.2 | O(2^N))
    * *Intent:* # ============================================================================== # JCL: STRICT STRUC...
  * `test_cpp_macro_multiline_spiral` (Impact: 263.1 | O(N^5) | DB: 19)
    * *Intent:* # The Pathological String: Deeply nested generics, missing the final brace,
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` scala.util.Try, Yesod, OpenAI, my.module, Foundation, unittest, Reactive.Banana, multiprocessing...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 30):` importlib.util, zipfile, gitgalaxy.security.security_auditor, subprocess, gitgalaxy.tools.ai_guardrails.dev_agent_firewall, gitgalaxy.core.network_risk_sensor, gitgalaxy.security.dependency_audit_cache, gitgalaxy.standards.language_lens...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` math, warnings, networkx, networkx.algorithms, typing, token, logging, collections...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` math, typing, statistics, logging, re, gitgalaxy.standards, os
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` math, typing, statistics, logging, os
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` math, gitgalaxy.standards.language_standards, typing, gitgalaxy.standards.gitgalaxy_config, time, logging, re, pathlib
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` std.core, type, mypack.myclass, gitgalaxy.engine, signatures, Foundation, url, java.util.List...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 3):` math, gitgalaxy.standards.language_standards, bisect, typing, time, tiktoken, logging, re...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.043
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.01929
  * `Imports (Out-Degree: 0):` json, typing, statistics, sqlite3, logging, collections, gitgalaxy.standards, heapq...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` must, subprocess, failure, unittest, name, tempfile, gitgalaxy.galaxyscope, re...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` json, typing, logging, re, pathlib, os
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` subprocess, typing, shutil, time, logging, gitgalaxy.standards, gitgalaxy.standards.config_resolver, pathlib...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` networkx, typing, logging, collections, xgboost, gitgalaxy.standards.analysis_lens, pathlib, numpy...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` math, pytest, with, gitgalaxy.core.spatial_mapper, gitgalaxy.standards.language_standards, gitgalaxy.standards.gitgalaxy_config, gitgalaxy.core.detector, re...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 9):` gitgalaxy.tools.cobol_to_cobol.cobol_jcl_forge, sys, gitgalaxy.tools.cobol_to_cobol.cobol_lexical_patcher, json, gitgalaxy.tools.cobol_to_cobol.cobol_agent_task_forge, gitgalaxy.tools.cobol_to_cobol.cobol_microservice_slicer, typing, gitgalaxy.tools.cobol_to_cobol.cobol_dag_architect...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` ast, sys, json, typing, argparse, pathlib
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` dataclasses, __future__, copy, typing, logging, gitgalaxy.standards, yaml
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 354.06 | **LOC:** 11964 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` type, inside, typing, re, java.util., keyword., path
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` identity, pytest, gitgalaxy.recorders.sarif_recorder, json, gitgalaxy.metrics.signal_processor, which, tempfile, os
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` sys, json, gitgalaxy.tools.cobol_to_java.cobol_to_java_api_contract_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_decoder_forge, org.slf4j.Logger, shutil, argparse, gitgalaxy.tools.cobol_to_java.cobol_to_java_service_forge...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 4):` gitgalaxy.standards.language_standards, json, typing, gitgalaxy.security.manifest_parser, gitgalaxy.standards.gitgalaxy_config, gitgalaxy.standards.language_lens, logging, uuid...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, pytest, json, unittest.mock, gitgalaxy.metrics.signal_processor, was, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, gitgalaxy.standards.config_resolver...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 8.043
  * `Choke Point (Betweenness):` 3.8e-05 | `Ripple Effect (Closeness):` 0.01929
  * `Imports (Out-Degree: 1):` fnmatch, json, typing, gitgalaxy.standards.gitgalaxy_config, logging, re, pathlib, os
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **74.31%** | Cog Load: 62.8023% | Debt: 0.0%
...
- `gitgalaxy/standards/language_standards.py` -> **Severity: 812.94** (Blast Radius: 48.419 * Doc Risk: 16.7897%)
