...
| **Timestamp** | `2026-08-02T23:00:28.582156+00:00` |
| **Scan Duration** | `8.76s` |
| **Git Branch** | `main` |
| **Git Commit** | `8c7661bfffe45440688634598d9b2a451bb8c901` |
...
|---|---|
| Total Artifacts | 695 |
| Analyzed Artifacts (Scanned) | 220 |
...
> **Architectural Drift Z-Score:** `4.906`
...
|---|---|---|
| file_cluster_8 | 125 | 56.8% |
| file_cluster_13 | 33 | 15.0% |
| file_cluster_0 | 19 | 8.6% |
...
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 35 | 15.9% |
...
| State Flux Exposure | 0.0 | 100.0 | 7.1 | 0.0 | 0.0 |
| Commented Logic Exposure | 0.0 | 9.8 | 0.2 | 0.0 | 0.0 |
| Specification Exposure | 0.0 | 100.0 | 16.0 | 0.0 | 0.0 |
| Instability Exposure | 0.0 | 33.8 | 1.1 | 0.0 | 0.0 |
| Volatility Exposure | 0.0 | 85.0 | 7.4 | 0.0 | 0.0 |
| Documentation Exposure | 0.0 | 100.0 | 4.9 | 0.0 | 0.0 |
| Algorithmic DoS Exposure | 0.0 | 100.0 | 8.9 | 0.0 | 0.0 |
...
1. **language_standards.py** (`gitgalaxy/standards/language_standards.py`) — 57 inbound connections
2. **_extraction_harness.py** (`tests/extraction/_extraction_harness.py`) — 40 inbound connections
...
### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **747.17**
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **681.96**
...
### 3. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **668.03**
...
### 4. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **666.64**
- **Archetype:** `file_cluster_8` (Distance: 12.511 IQR)
- **Magnitude:** 3862.46 | **LOC:** 3044 | **CtrlFlow:** 71.1% | **Authorship Centralization:** 65.6%
- **Primary Risk Drivers:** Spec Match (100.0%), Algorithmic Dos (100.0%), Logic Bomb (100.0%), Churn (85.01%)
- **Heaviest Functions:** `execute_pipeline` (Impact: 2143.0), `main` (Impact: 869.6), `_process_file_worker` (Impact: 611.9)

### 5. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **655.91**
...
### 6. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **655.36**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **652.39**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **646.08**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **638.9**
...
### 10. `gitgalaxy/recorders/sarif_recorder.py` (PYTHON) -> Cumulative Risk: **633.67**
- **Archetype:** `file_cluster_8` (Distance: 9.791 IQR)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` Brick, Foundation, kotlin.collections.List, shapes, x, multiprocessing, url, Yesod...
...
- **Top Global Matches:** file_cluster_8: 12.511, file_cluster_13: 12.648, file_cluster_7: 12.897
- **Magnitude:** 3862.46 | **LOC:** 3044 | **CtrlFlow:** 71.1% | **Authorship Centralization:** 65.6%
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 6.04
  * `Choke Point (Betweenness):` 0.001801 | `Ripple Effect (Closeness):` 0.013699
  * `Imports (Out-Degree: 30):` is, gitgalaxy.recorders.sarif_recorder, gitgalaxy.security.security_auditor, gitgalaxy.recorders.audit_recorder, typing, collections, gitgalaxy.recorders.gpu_recorder, gitgalaxy.metrics.tensor_scanner...
...
- **Top Global Matches:** file_cluster_13: 11.183, file_cluster_8: 11.246, file_cluster_16: 11.319
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 7.715
  * `Choke Point (Betweenness):` 3.8e-05 | `Ripple Effect (Closeness):` 0.022374
  * `Imports (Out-Degree: 1):` networkx, pathlib, gitgalaxy.standards.analysis_lens, typing, collections, math, networkx.algorithms, warnings...
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 7.723
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.026567
  * `Imports (Out-Degree: 0):` os, typing, gitgalaxy.standards, math, statistics, logging, re
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 5.781
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.014269
  * `Imports (Out-Degree: 0):` os, typing, math, statistics, logging
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, typing, gitgalaxy.standards.language_standards, time, math, logging, gitgalaxy.standards.gitgalaxy_config, re
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 4.579
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.018265
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 9.1e-05 | `Ripple Effect (Closeness):` 0.018265
  * `Imports (Out-Degree: 3):` bisect, gitgalaxy.standards.analysis_lens, typing, gitgalaxy.standards.language_standards, tiktoken, collections, time, math...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 5.781
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.014269
  * `Imports (Out-Degree: 0):` json, pathlib, typing, collections, gitgalaxy.standards, statistics, sqlite3, logging...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` must, or, logging, pathlib, gitgalaxy.standards.analysis_lens, unittest, re, failure...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pytest, gitgalaxy.standards.language_standards, signatures, UIKit, formatting, mypack.myclass, matlab.unittest., url
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, pytest, gitgalaxy.standards.language_standards, sys, extraction._extraction_harness
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` logging, os, pathlib, typing, json, re
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 5.781
  * `Choke Point (Betweenness):` 2.1e-05 | `Ripple Effect (Closeness):` 0.014269
  * `Imports (Out-Degree: 1):` shutil, os, subprocess, pathlib, typing, gitgalaxy.standards, time, gitgalaxy.standards.config_resolver...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pytest, unittest.mock, gitgalaxy.standards.language_standards, gitgalaxy.core.spatial_mapper, math, gitgalaxy.standards.gitgalaxy_config, with, logging...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` networkx, pathlib, xgboost, gitgalaxy.standards.analysis_lens, typing, collections, logging, pandas...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, pytest, ..., gitgalaxy.standards.language_standards, sys, typing, static, _extraction_harness...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 5.61
  * `Choke Point (Betweenness):` 0.000189 | `Ripple Effect (Closeness):` 0.004566
  * `Imports (Out-Degree: 9):` gitgalaxy.licensing, gitgalaxy.tools.cobol_to_cobol.cobol_dag_architect, gitgalaxy.tools.cobol_to_cobol.cobol_system_limits_reporter, pathlib, gitgalaxy.tools.cobol_to_cobol.cobol_graveyard_finder, gitgalaxy.tools.cobol_to_cobol.cobol_microservice_slicer, typing, sys...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, pytest, gitgalaxy.standards.language_standards, sys, _extraction_harness
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` json, pathlib, typing, sys, argparse, ast
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 360.9 | **LOC:** 12641 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` inside, keyword., file, typing, was, scala.util., java.util., form...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` typing, __future__, dataclasses, gitgalaxy.standards, logging, copy, yaml
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` identity, which, pytest, os, gitgalaxy.recorders.sarif_recorder, tempfile, json, gitgalaxy.metrics.signal_processor
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` bypassed, pytest, pathlib, unittest.mock, sys, was, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, gitgalaxy.metrics.signal_processor...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.033
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` gitgalaxy.licensing, shutil, pathlib, org.slf4j.Logger, gitgalaxy.tools.cobol_to_java.cobol_to_java_spring_forge, sys, gitgalaxy.tools.cobol_to_java.cobol_to_java_agent_forge, org.slf4j.LoggerFactory...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **66.56%** | Cog Load: 63.0362% | Debt: 0.0%
...
- `gitgalaxy/galaxyscope.py` -> **Severity: 0.14** (Bridge: 0.0018 * Flux: 77.6198%)
- `gitgalaxy/cobol_refractor_controller.py` -> **Severity: 0.018** (Bridge: 0.0002 * Flux: 97.0538%)
- `gitgalaxy/recorders/sbom_recorder.py` -> **Severity: 0.016** (Bridge: 0.0002 * Flux: 97.0328%)
- `gitgalaxy/security/security_auditor.py` -> **Severity: 0.005** (Bridge: 0.0 * Flux: 94.0786%)
- `gitgalaxy/core/detector.py` -> **Severity: 0.004** (Bridge: 0.0001 * Flux: 49.3923%)

### 🃏 House of Cards (Closeness * Error Risk)
These files are deeply embedded (1 or 2 hops from the entire codebase) but possess high error exposure. A runtime exception here will cascade instantly across the application.

- `gitgalaxy/standards/config_resolver.py` -> **Severity: 3.914** (Embedded: 0.0489 * Error Risk: 80.0%)
- `gitgalaxy/core/network_risk_sensor.py` -> **Severity: 1.629** (Embedded: 0.0224 * Error Risk: 72.8082%)
- `gitgalaxy/standards/language_standards.py` -> **Severity: 1.272** (Embedded: 0.2643 * Error Risk: 4.8114%)
- `gitgalaxy/recorders/sarif_recorder.py` -> **Severity: 1.153** (Embedded: 0.0183 * Error Risk: 63.1492%)
- `gitgalaxy/tools/ai_guardrails/ai_appsec_sensor.py` -> **Severity: 1.142** (Embedded: 0.0143 * Error Risk: 80.0%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `gitgalaxy/standards/config_resolver.py` -> **Severity: 2378.0** (Blast Radius: 23.78 * Doc Risk: 100.0%)
- `gitgalaxy/standards/language_standards.py` -> **Severity: 1539.262** (Blast Radius: 88.932 * Doc Risk: 17.3083%)
- `gitgalaxy/metrics/tensor_scanner.py` -> **Severity: 578.1** (Blast Radius: 5.781 * Doc Risk: 100.0%)
- `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` -> **Severity: 561.0** (Blast Radius: 5.61 * Doc Risk: 100.0%)
- `gitgalaxy/tools/network_auditing/full_api_network_map.py` -> **Severity: 544.842** (Blast Radius: 5.781 * Doc Risk: 94.247%)
