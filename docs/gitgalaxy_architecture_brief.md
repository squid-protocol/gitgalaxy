...
| **Timestamp** | `2026-07-30T14:01:53.697689+00:00` |
| **Scan Duration** | `7.27s` |
| **Git Branch** | `main` |
| **Git Commit** | `595e91b7877879a1dfa7d6791982492ba8fe43cb` |
...
|---|---|---|
| Modularity | 0.6087 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
| Instability Exposure | 0.0 | 32.1 | 1.3 | 0.0 | 0.0 |
| Volatility Exposure | 0.0 | 99.3 | 11.0 | 0.0 | 0.0 |
...
- `f` (@ `tests/core_engine/test_language_standards_strict.py`) -> DB Complexity: **58**
...
### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **753.47**
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **687.67**
...
- **Primary Risk Drivers:** Spec Match (100.0%), Algorithmic Dos (100.0%), Logic Bomb (100.0%), Churn (99.31%)
- **Heaviest Functions:** `execute_pipeline` (Impact: 2143.0), `main` (Impact: 869.6), `_process_file_worker` (Impact: 611.9)

### 4. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **672.79**
...
### 5. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **665.44**
...
### 6. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **663.72**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **655.9**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **652.1**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **645.47**
...
### 10. `gitgalaxy/recorders/sarif_recorder.py` (PYTHON) -> Cumulative Risk: **639.5**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 30):` gitgalaxy.standards.language_standards, zipfile, gitgalaxy.core.aperture, gitgalaxy.core.network_risk_sensor, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, gitgalaxy.tools.ai_guardrails.dev_agent_firewall, time, DAG...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)

### `tests/core_engine/test_language_standards_strict.py` (PYTHON | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 3751.72 | **LOC:** 12782 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` kotlin.collections.List, gitgalaxy.standards.language_standards, Reactive.Banana, time, mypackage.MyClass, numpy, and, com.example.gradle.Plugin...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` collections, math, networkx, networkx.algorithms, token, warnings, logging, typing...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` gitgalaxy.standards, math, logging, re, typing, statistics, os
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.standards.language_standards, math, time, logging, typing, re, gitgalaxy.standards.gitgalaxy_config, pathlib
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.standards.language_standards, formatting, type, numpy, mypack.myclass, fmt, machine, pytest...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 3):` bisect, gitgalaxy.standards.language_standards, collections, math, time, tiktoken, logging, typing...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.043
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.01929
  * `Imports (Out-Degree: 0):` gitgalaxy.standards, collections, json, heapq, sqlite3, logging, typing, statistics...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.core.aperture, or, gitgalaxy.galaxyscope, unittest, sys, name, pathlib, yaml...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` json, logging, typing, re, os, pathlib
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` gitgalaxy.standards, subprocess, time, shutil, logging, gitgalaxy.standards.config_resolver, typing, os...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` collections, networkx, xgboost, numpy, logging, typing, pandas, gitgalaxy.standards.analysis_lens...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.standards.language_standards, math, gitgalaxy.core.detector, gitgalaxy.core.spatial_mapper, logging, unittest.mock, with, pytest...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 9):` datetime, json, argparse, gitgalaxy.licensing, gitgalaxy.tools.cobol_to_cobol.cobol_system_limits_reporter, gitgalaxy.tools.cobol_to_cobol.cobol_graveyard_finder, gitgalaxy.tools.cobol_to_cobol.cobol_schema_forge, sqlite3...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` json, argparse, ast, typing, sys, pathlib
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` yaml, gitgalaxy.standards, dataclasses, logging, __future__, typing, copy
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 353.86 | **LOC:** 11799 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` inside, type, java.util., re, path, typing, keyword.
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` json, tempfile, identity, pytest, gitgalaxy.recorders.sarif_recorder, which, os, gitgalaxy.metrics.signal_processor
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` json, argparse, gitgalaxy.licensing, gitgalaxy.tools.cobol_to_java.cobol_to_java_build_forge, shutil, gitgalaxy.tools.cobol_to_java.cobol_to_java_agent_forge, org.slf4j.LoggerFactory, org.springframework.stereotype.Service...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 4):` datetime, json, gitgalaxy.standards.language_standards, logging, gitgalaxy.standards.language_lens, typing, gitgalaxy.security.security_lens, gitgalaxy.standards.gitgalaxy_config...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` yaml, json, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, bypassed, policy, unittest.mock, gitgalaxy.standards.config_resolver, was...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 8.043
  * `Choke Point (Betweenness):` 3.8e-05 | `Ripple Effect (Closeness):` 0.01929
  * `Imports (Out-Degree: 1):` json, logging, typing, fnmatch, re, gitgalaxy.standards.gitgalaxy_config, os, pathlib
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **75.06%** | Cog Load: 62.8023% | Debt: 0.0%
...
- `gitgalaxy/standards/language_standards.py` -> **Severity: 810.636** (Blast Radius: 48.419 * Doc Risk: 16.7421%)
