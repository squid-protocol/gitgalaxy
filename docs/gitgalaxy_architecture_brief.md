...
| **Timestamp** | `2026-08-27T08:25:23.818194+00:00` |
| **Scan Duration** | `10.03s` |
| **Git Branch** | `main` |
| **Git Commit** | `2064d02a2bf715f282001f459f4b267f01f4346e` |
...
| Instability Exposure | 0.0 | 16.2 | 0.8 | 0.0 | 0.0 |
...
### 1. `gitgalaxy/recorders/llm_recorder.py` (PYTHON) -> Cumulative Risk: **545.54**
...
### 2. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **500.81**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 3. `gitgalaxy/core/detector.py` (PYTHON) -> Cumulative Risk: **491.37**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 4. `gitgalaxy/recorders/gpu_recorder.py` (PYTHON) -> Cumulative Risk: **471.65**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 6. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **439.06**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 7. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **432.74**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 8. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **412.88**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 9. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **410.9**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 10. `gitgalaxy/metrics/signal_processor.py` (PYTHON) -> Cumulative Risk: **408.1**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
