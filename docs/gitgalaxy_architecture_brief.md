...
| **Timestamp** | `2026-07-31T04:19:34.400819+00:00` |
| **Scan Duration** | `7.97s` |
| **Git Branch** | `main` |
| **Git Commit** | `93abae11aa4c38e8e6cf4b9f43dfb006849e3b21` |
...
| Avg Path Length | 2.8956 | Hops between files. Lower = Tighter coupling. |
| Articulation Pts | 36 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| PYTHON | 140 | 51008 | 80.0% |
| MARKDOWN | 24 | 0 | 13.7% |
| YAML | 8 | 481 | 4.6% |
| PLAINTEXT | 3 | 0 | 1.7% |
...
|---|---|---|
| file_cluster_8 | 103 | 58.9% |
| file_cluster_13 | 29 | 16.6% |
| file_cluster_0 | 9 | 5.1% |
...
| Specification Exposure | 0.0 | 100.0 | 17.3 | 0.0 | 0.0 |
| Instability Exposure | 0.0 | 32.4 | 1.2 | 0.0 | 0.0 |
| Volatility Exposure | 0.0 | 94.4 | 9.7 | 0.0 | 0.0 |
...
1. **language_standards.py** (`gitgalaxy/standards/language_standards.py`) — 25 inbound connections
2. **config_resolver.py** (`gitgalaxy/standards/config_resolver.py`) — 9 inbound connections
3. **_extraction_harness.py** (`tests/extraction/_extraction_harness.py`) — 8 inbound connections
...
| `tests/extraction` | 7 | 1362.3 | 3.48% | 0.0% |
| `gitgalaxy/security` | 5 | 1301.56 | 12.05% | 0.0% |
| `tests/extraction/languages` | 8 | 945.18 | 2.36% | 0.0% |
...
- **Unknown Dependencies:** `931` packages imported that bypass the Zero-Trust whitelist.
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **685.42**
...
### 5. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **662.97**
...
### 6. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **662.06**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **654.45**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **649.18**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **642.82**
...
### 10. `gitgalaxy/recorders/sarif_recorder.py` (PYTHON) -> Cumulative Risk: **637.13**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` and, x, gitgalaxy.standards.language_standards, com.example.gradle.Plugin, com.example.foo.Bar, still, numpy, Numeric.LinearAlgebra...
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 7.733
  * `Choke Point (Betweenness):` 0.002857 | `Ripple Effect (Closeness):` 0.017241
  * `Imports (Out-Degree: 30):` subprocess, gitgalaxy.security.security_lens, concurrent.futures, gitgalaxy.standards.language_standards, gitgalaxy.core.aperture, shutil, zipfile, gitgalaxy.security.dependency_audit_cache...
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 9.878
  * `Choke Point (Betweenness):` 6.1e-05 | `Ripple Effect (Closeness):` 0.028161
  * `Imports (Out-Degree: 1):` gitgalaxy.standards.analysis_lens, token, logging, typing, warnings, pathlib, networkx, networkx.algorithms...
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 9.888
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.033438
  * `Imports (Out-Degree: 0):` logging, typing, re, statistics, os, gitgalaxy.standards, math
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 7.402
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.01796
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` logging, gitgalaxy.standards.gitgalaxy_config, typing, gitgalaxy.standards.language_standards, re, math, pathlib, time
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 5.862
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.022989
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 5.587
  * `Choke Point (Betweenness):` 0.000144 | `Ripple Effect (Closeness):` 0.022989
  * `Imports (Out-Degree: 3):` gitgalaxy.standards.analysis_lens, tiktoken, logging, bisect, typing, gitgalaxy.standards.language_standards, re, math...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)

### `tests/extraction/test_dependency_extraction_strict.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 818.4 | **LOC:** 337 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` cats.effect.IO, formatting, gitgalaxy.standards.language_standards, static, qualified, java.util., UIKit, signatures...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 7.402
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.01796
  * `Imports (Out-Degree: 0):` sqlite3, logging, typing, heapq, statistics, gitgalaxy.standards, json, pathlib...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` subprocess, concurrent.futures, failure, gitgalaxy.core.aperture, unittest.mock, passes, gitgalaxy.standards, name...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 3.3e-05 | `Ripple Effect (Closeness):` 0.01796
  * `Imports (Out-Degree: 1):` subprocess, logging, typing, shutil, os, gitgalaxy.standards, gitgalaxy.standards.config_resolver, pathlib...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` logging, gitgalaxy.standards.gitgalaxy_config, gitgalaxy.standards.language_standards, gitgalaxy.core.prism, re, gitgalaxy.core.detector, math, gitgalaxy.core.spatial_mapper...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` logging, typing, numpy, pathlib, networkx, pandas, xgboost, collections...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` statement, gitgalaxy.standards.language_standards, typing, _extraction_harness, static, java.util., pathlib, pytest...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 7.183
  * `Choke Point (Betweenness):` 0.000299 | `Ripple Effect (Closeness):` 0.005747
  * `Imports (Out-Degree: 9):` sqlite3, gitgalaxy.tools.cobol_to_cobol.cobol_jcl_forge, gitgalaxy.licensing, typing, gitgalaxy.tools.cobol_to_cobol.cobol_agent_task_forge, gitgalaxy.tools.cobol_to_cobol.cobol_jcl_auditor, gitgalaxy.tools.cobol_to_cobol.cobol_dag_architect, gitgalaxy.tools.cobol_to_cobol.cobol_graveyard_finder...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` typing, json, pathlib, sys, argparse, ast
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` copy, __future__, logging, yaml, typing, gitgalaxy.standards, dataclasses
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 352.72 | **LOC:** 12252 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` keyword., inside, typing, re, path, java.util., type
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` identity, tempfile, os, gitgalaxy.metrics.signal_processor, json, pytest, gitgalaxy.recorders.sarif_recorder, which
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` yaml, policy, bypassed, multiprocessing, was, json, gitgalaxy.standards.config_resolver, pathlib...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.883
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` org.slf4j.Logger, gitgalaxy.licensing, shutil, org.springframework.stereotype.Service, gitgalaxy.tools.cobol_to_java.cobol_to_java_agent_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_decoder_forge, json, gitgalaxy.tools.cobol_to_java.cobol_to_java_service_forge...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000266 | `Ripple Effect (Closeness):` 0.022989
  * `Imports (Out-Degree: 4):` logging, gitgalaxy.security.security_lens, gitgalaxy.standards.gitgalaxy_config, typing, gitgalaxy.standards.language_standards, uuid, os, gitgalaxy.standards.language_lens...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Defense:* `doc: 10`
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 4.762
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.01796
...
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **71.35%** | Cog Load: 62.8023% | Debt: 0.0%
...
- `gitgalaxy/galaxyscope.py` -> **Severity: 0.222** (Bridge: 0.0029 * Flux: 77.6198%)
...
- `gitgalaxy/standards/config_resolver.py` -> **Severity: 4.926** (Embedded: 0.0616 * Error Risk: 80.0%)
- `gitgalaxy/core/network_risk_sensor.py` -> **Severity: 2.05** (Embedded: 0.0282 * Error Risk: 72.8082%)
- `gitgalaxy/recorders/sarif_recorder.py` -> **Severity: 1.452** (Embedded: 0.023 * Error Risk: 63.1492%)
- `gitgalaxy/tools/ai_guardrails/ai_appsec_sensor.py` -> **Severity: 1.437** (Embedded: 0.018 * Error Risk: 80.0%)
- `gitgalaxy/recorders/llm_recorder.py` -> **Severity: 1.376** (Embedded: 0.018 * Error Risk: 76.6083%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `gitgalaxy/standards/config_resolver.py` -> **Severity: 3044.6** (Blast Radius: 30.446 * Doc Risk: 100.0%)
- `gitgalaxy/standards/language_standards.py` -> **Severity: 1036.198** (Blast Radius: 61.066 * Doc Risk: 16.9685%)
- `gitgalaxy/metrics/tensor_scanner.py` -> **Severity: 740.2** (Blast Radius: 7.402 * Doc Risk: 100.0%)
- `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` -> **Severity: 718.3** (Blast Radius: 7.183 * Doc Risk: 100.0%)
- `gitgalaxy/tools/network_auditing/full_api_network_map.py` -> **Severity: 683.59** (Blast Radius: 7.402 * Doc Risk: 92.352%)
