...
| **Timestamp** | `2026-08-23T20:00:46.061071+00:00` |
| **Scan Duration** | `10.16s` |
| **Git Branch** | `main` |
| **Git Commit** | `dd418a51cad9f78a7506a605985c96211aca8f0a` |
...
| Instability Exposure | 0.0 | 14.3 | 0.6 | 0.0 | 0.0 |
...
- `splice` (@ `gitgalaxy/core/detector.py`) -> Impact: **232.4** | LOC: 415
- `slice_manifest` (@ `gitgalaxy/security/manifest_parser.py`) -> Impact: **211.6** | LOC: 272
- `measure` (@ `tests/tools/tree_sitter_accuracy_audit.py`) -> Impact: **200.5** | LOC: 408
  * *Intent:* """Runs the full pinned-corpus scan + tree-sitter diff, returns the metrics dict."""

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `tests/extraction/languages` | 92 | 6653.32 | 3.43% | 0.0% |
| `gitgalaxy/core` | 9 | 4722.78 | 14.24% | 7.96% |
| `gitgalaxy/recorders` | 8 | 2563.28 | 23.46% | 3.12% |
| `tests/core_engine` | 22 | 2534.94 | 3.07% | 0.0% |
| `gitgalaxy/metrics` | 5 | 1629.48 | 16.56% | 4.56% |
| `gitgalaxy` | 6 | 1508.64 | 8.62% | 0.0% |
...
- `gitgalaxy/core/detector.py` -> **31.0121%** Exposure
...
### 2. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **500.05**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 3. `gitgalaxy/core/detector.py` (PYTHON) -> Cumulative Risk: **489.19**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 3277.12 | **LOC:** 5397 | **CtrlFlow:** 76.0% | **Authorship Centralization:** 91.8%
- **Primary Risk Drivers:** Spec Match (100.0%), Churn (100.0%), Verification (80.0%), Safety Score (60.4492%)
- **Heaviest Functions:** `_slice_by_braces` (Impact: 765.9), `_calculate_block_metrics` (Impact: 306.8), `splice` (Impact: 232.4)

### 4. `gitgalaxy/recorders/gpu_recorder.py` (PYTHON) -> Cumulative Risk: **470.86**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 6. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **438.36**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 7. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **424.41**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1246.76 | **LOC:** 3088 | **CtrlFlow:** 71.1% | **Authorship Centralization:** 100.0%
...
### 8. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **411.85**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 9. `gitgalaxy/metrics/signal_processor.py` (PYTHON) -> Cumulative Risk: **411.09**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 10. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **409.78**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Magnitude:** 3277.12 | **LOC:** 5397 | **CtrlFlow:** 76.0% | **Authorship Centralization:** 91.8%
- **Risk Profile:** Cognitive Load (19.0013%), Tech Debt (31.0121%)
...
* *Structure:* `branch: 1084`, `structural_boundaries: 343`, `args: 53`, `func_start: 51`, `class_start: 6`
* *Risk/State:* `safety_bypasses: 72`, `state_mutation: 188`, `dead_code: 30`, `planned_debt: 1`, `fragile_debt: 18`, `duplicate_logic: 2`
* *Architecture:* `api: 19`, `concurrency: 1`, `import: 14`
* *Defense:* `safety: 46`, `doc: 111`, `test: 2`, `immutability_locks: 10`
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 14.229
  * `Choke Point (Betweenness):` 0.000324 | `Ripple Effect (Closeness):` 0.051607
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 4.262
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1246.76 | **LOC:** 3088 | **CtrlFlow:** 71.1% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (20.8531%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
* *Sec High Risk Execution:* 1 instances
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 540`, `structural_boundaries: 219`, `args: 33`, `func_start: 23`, `class_start: 1`
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 4.448
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 7.593
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 10.591
...
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 639.32 | **LOC:** 3383 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 4.262
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 4.737
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 4.132
...
- `gitgalaxy/core/detector.py` -> **Joe Esquibel** (91.8% isolated ownership) | Magnitude: 3277.12
- `gitgalaxy/recorders/llm_recorder.py` -> **Joe Esquibel** (87.5% isolated ownership) | Magnitude: 1564.86
- `gitgalaxy/galaxyscope.py` -> **Joe Esquibel** (100.0% isolated ownership) | Magnitude: 1246.76
...
- `gitgalaxy/galaxyscope.py` -> **Severity: 0.084** (Bridge: 0.0011 * Flux: 79.0753%)
- `gitgalaxy/core/detector.py` -> **Severity: 0.018** (Bridge: 0.0003 * Flux: 55.8382%)
...
- `gitgalaxy/core/detector.py` -> **Severity: 3.12** (Embedded: 0.0516 * Error Risk: 60.4492%)
...
- `gitgalaxy/core/detector.py` -> **Severity: 247.466** (Blast Radius: 14.229 * Doc Risk: 17.3917%)
