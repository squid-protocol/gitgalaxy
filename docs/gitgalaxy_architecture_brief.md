...
| **Timestamp** | `2026-07-25T13:18:35.336250+00:00` |
| **Scan Duration** | `4.43s` |
| **Git Branch** | `main` |
| **Git Commit** | `cb60c2bb4a4b3b200a4eda20d4ced03138625204` |
...
|---|---|
| Total Artifacts | 621 |
| Analyzed Artifacts (Scanned) | 159 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 462 |
| Total LOC | 42358 |
...
|---|---|---|
| file_cluster_8 | 100 | 62.9% |
| file_cluster_13 | 23 | 14.5% |
...
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 25 | 15.7% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 462*
...
| Specification Exposure | 0.0 | 100.0 | 18.3 | 0.0 | 0.0 |
| Instability Exposure | 0.0 | 29.4 | 1.1 | 0.0 | 0.0 |
| Volatility Exposure | 0.0 | 100.0 | 10.3 | 0.0 | 0.0 |
| Documentation Exposure | 0.0 | 100.0 | 5.3 | 0.0 | 0.0 |
| Algorithmic DoS Exposure | 0.0 | 100.0 | 12.3 | 0.0 | 0.0 |
...
- `_process_file_worker` (@ `gitgalaxy/galaxyscope.py`) -> Impact: **611.6** | LOC: 473
...
- `_tier_2_fingerprint_check` (@ `gitgalaxy/standards/language_lens.py`) -> Impact: **533.5** | LOC: 309
...
|---|---|---|---|---|
| `gitgalaxy` | 6 | 4608.18 | 11.02% | 0.0% |
| `gitgalaxy/metrics` | 5 | 3147.3 | 16.85% | 2.97% |
| `tests/core_engine` | 17 | 2541.02 | 2.7% | 0.0% |
| `gitgalaxy/core` | 9 | 2296.98 | 14.03% | 3.41% |
| `gitgalaxy/standards` | 8 | 2030.28 | 7.82% | 10.19% |
| `gitgalaxy/recorders` | 8 | 1554.4 | 21.58% | 1.79% |
| `gitgalaxy/security` | 5 | 1539.2 | 12.58% | 0.0% |
| `tests/security_auditing` | 16 | 1420.2 | 1.93% | 0.0% |
| `tests/extraction` | 5 | 1373.14 | 2.93% | 0.0% |
| `tests` | 5 | 658.24 | 8.62% | 0.0% |
...
- `gitgalaxy/core/detector.py` -> **8.1001%** Exposure
...
- **Unknown Dependencies:** `757` packages imported that bypass the Zero-Trust whitelist.

## 11. CUMULATIVE RISK HITLIST (Top 10 Highest Risk Files)
> Cumulative Risk is the sum of all individual risk exposures. These files represent the highest multi-dimensional technical debt and architectural fragility.

### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **735.23**
- **Archetype:** `file_cluster_13` (Distance: 11.263 IQR)
- **Magnitude:** 257.28 | **LOC:** 233 | **CtrlFlow:** 61.7% | **Authorship Centralization:** 57.1%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Algorithmic Dos (100.0%), Logic Bomb (100.0%)
- **Heaviest Functions:** `map_repository` (Impact: 189.4), `__init__` (Impact: 11.5), `_hash_jitter` (Impact: 8.4)

### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **684.14**
...
### 3. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **679.53**
- **Archetype:** `file_cluster_8` (Distance: 12.578 IQR)
- **Magnitude:** 3819.86 | **LOC:** 2985 | **CtrlFlow:** 71.2% | **Authorship Centralization:** 61.3%
- **Primary Risk Drivers:** Spec Match (100.0%), Churn (100.0%), Algorithmic Dos (100.0%), Logic Bomb (100.0%)
- **Heaviest Functions:** `execute_pipeline` (Impact: 2148.3), `main` (Impact: 819.8), `_process_file_worker` (Impact: 611.6)

### 4. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **667.09**
...
### 5. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **659.84**
...
### 6. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **654.56**
- **Archetype:** `file_cluster_16` (Distance: 11.819 IQR)
- **Magnitude:** 757.26 | **LOC:** 663 | **CtrlFlow:** 61.5% | **Authorship Centralization:** 54.5%
...
### 7. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **645.1**
...
### 8. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **638.47**
...
### 9. `gitgalaxy/recorders/sarif_recorder.py` (PYTHON) -> Cumulative Risk: **630.5**
...
### 10. `gitgalaxy/metrics/tensor_scanner.py` (PYTHON) -> Cumulative Risk: **621.29**
...
- **Top Global Matches:** file_cluster_8: 12.578, file_cluster_13: 12.694, file_cluster_7: 12.961
- **Magnitude:** 3819.86 | **LOC:** 2985 | **CtrlFlow:** 71.2% | **Authorship Centralization:** 61.3%
- **Algorithmic:** O(2^N) [Recursive] | **DB Complexity:** 52
- **Risk Profile:** Cognitive Load (34.1683%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `execute_pipeline` (Impact: 2148.3 | O(N^6) | DB: 52)
  * `main` (Impact: 819.8 | O(2^N) | DB: 23)
  * `_process_file_worker` (Impact: 611.6 | O(N^6) | DB: 13)
...
* *Risk/State:* `safety_bypasses: 76`, `state_mutation: 185`
* *Architecture:* `io: 13`, `api: 6`, `concurrency: 3`, `import: 65`
* *Defense:* `safety: 72`, `doc: 36`, `test: 1`, `cleanup: 6`
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 8.544
  * `Choke Point (Betweenness):` 0.003467 | `Ripple Effect (Closeness):` 0.018987
  * `Imports (Out-Degree: 30):` gitgalaxy.metrics.chronometer, time, gitgalaxy.core.spatial_mapper, gitgalaxy.state_rehydrator, argparse, gitgalaxy.recorders.record_keeper, gitgalaxy.core.guidestar_lens, gitgalaxy.security.security_auditor...
...
- **Top Global Matches:** file_cluster_8: 11.146, file_cluster_16: 11.539, file_cluster_7: 11.605
- **Magnitude:** 1177.82 | **LOC:** 2472 | **CtrlFlow:** 76.2% | **Authorship Centralization:** 63.2%
...
* *Sec High Risk Execution:* 1 instances
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 443`, `structural_boundaries: 138`, `args: 44`, `func_start: 36`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 40`, `state_mutation: 92`
* *Architecture:* `io: 1`, `api: 11`, `concurrency: 2`, `import: 8`
* *Defense:* `safety: 72`, `doc: 50`, `sync_locks: 1`
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 10.925
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.036824
  * `Imports (Out-Degree: 0):` typing, statistics, logging, math, re, os, gitgalaxy.standards
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.178
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.019778
  * `Imports (Out-Degree: 0):` typing, statistics, logging, math, os
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)

### `gitgalaxy/standards/language_lens.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 1112.64 | **LOC:** 1121 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_tier_2_fingerprint_check` (Impact: 533.5 | O(N^6) | DB: 1)
    * *Intent:* # DEFENSIVE GUARD: Collisions cannot be locked at Tier 1 based on extension alone. # This prevents g...
  * `_find_balanced_end` (Impact: 398.6 | O(2^N) | DB: 2)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` typing, time, gitgalaxy.standards.language_standards, logging, math, re, pathlib, gitgalaxy.standards.gitgalaxy_config
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` qualified, Foundation, fmt, matlab.unittest., cats.effect.IO, java.util., numpy, UIKit...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/security/manifest_parser.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 913.32 | **LOC:** 391 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  ...
  * `locate_physical_package` (Impact: 238.1 | O(N^6) | DB: 6)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` typing, json, logging, re, pathlib, os
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/core/detector.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_8` (Drift: 11.07 IQR)
- **Local Micro-Species:** `Cluster 1: Declarative Glue & Initialization` (Drift: 4.066 IQR)
- **Top Global Matches:** file_cluster_8: 11.07, file_cluster_16: 11.449, file_cluster_7: 11.473
- **Magnitude:** 867.8 | **LOC:** 2255 | **CtrlFlow:** 74.1% | **Authorship Centralization:** 52.0%
- **Algorithmic:** O(N^6) | **DB Complexity:** 3
- **Risk Profile:** Cognitive Load (14.1301%), Tech Debt (8.1001%)
**Top Internal Functions/Classes:**
...
* *Sec High Risk Execution:* 1 instances
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 413`, `structural_boundaries: 144`, `args: 21`, `func_start: 20`, `class_start: 4`
* *Risk/State:* `safety_bypasses: 45`, `state_mutation: 94`, `dead_code: 1`, `planned_debt: 1`
* *Architecture:* `api: 13`, `concurrency: 1`, `import: 11`
* *Defense:* `safety: 39`, `doc: 63`, `test: 2`
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 7.266
  * `Choke Point (Betweenness):` 0.000215 | `Ripple Effect (Closeness):` 0.025316
  * `Imports (Out-Degree: 3):` typing, time, tiktoken, gitgalaxy.standards.language_standards, collections, logging, math, re...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
- **Top Global Matches:** file_cluster_8: 13.356, file_cluster_13: 13.65, file_cluster_11: 13.69
- **Magnitude:** 815.88 | **LOC:** 1507 | **CtrlFlow:** 87.5% | **Authorship Centralization:** 62.5%
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.178
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.019778
  * `Imports (Out-Degree: 0):` heapq, typing, json, statistics, logging, pathlib, collections, gitgalaxy.standards...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` unittest.mock, passes, failure, pathlib, sys, gitgalaxy.galaxyscope, subprocess, yaml...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/core/prism.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_16` (Drift: 11.819 IQR)
- **Local Micro-Species:** `Cluster 1: Declarative Glue & Initialization` (Drift: 5.126 IQR)
- **Top Global Matches:** file_cluster_16: 11.819, file_cluster_8: 11.876, file_cluster_13: 12.076
- **Magnitude:** 757.26 | **LOC:** 663 | **CtrlFlow:** 61.5% | **Authorship Centralization:** 54.5%
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 5.747
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.019778
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 8.178
  * `Choke Point (Betweenness):` 4e-05 | `Ripple Effect (Closeness):` 0.019778
  * `Imports (Out-Degree: 1):` typing, time, gitgalaxy.standards.config_resolver, subprocess, logging, pathlib, os, gitgalaxy.standards
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` numpy, networkx, gitgalaxy.standards.analysis_lens, pandas, xgboost, logging, pathlib, collections
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 7.936
  * `Choke Point (Betweenness):` 0.000363 | `Ripple Effect (Closeness):` 0.006329
  * `Imports (Out-Degree: 9):` sys, gitgalaxy.tools.cobol_to_cobol.cobol_agent_task_forge, gitgalaxy.licensing, gitgalaxy.tools.cobol_to_cobol.cobol_dag_architect, typing, gitgalaxy.tools.cobol_to_cobol.cobol_microservice_slicer, json, gitgalaxy.tools.cobol_to_cobol.cobol_system_limits_reporter...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` unittest.mock, gitgalaxy.core.spatial_mapper, with, pytest, logging, math, re, gitgalaxy.core.detector
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, typing, json, argparse, pathlib, ast
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` typing, copy, __future__, yaml, logging, dataclasses, gitgalaxy.standards
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` which, gitgalaxy.metrics.signal_processor, tempfile, json, pytest, gitgalaxy.recorders.sarif_recorder, identity, os
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 354.14 | **LOC:** 10544 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` path, type, inside, keyword., re, java.util.
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/cobol_to_java_controller.py` (PYTHON | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_8` (Drift: 8.791 IQR)
- **Local Micro-Species:** `Cluster 3: Data Pipelines & I/O Operations` (Drift: 5.187 IQR)
- **Top Global Matches:** file_cluster_8: 8.791, file_cluster_13: 9.243, file_cluster_7: 9.39
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 4.29
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` org.springframework.stereotype.Service, sys, gitgalaxy.licensing, org.slf4j.Logger, gitgalaxy.tools.cobol_to_java.cobol_to_java_build_forge, json, gitgalaxy.tools.cobol_to_java.cobol_to_java_decoder_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_service_forge...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 10.001
  * `Choke Point (Betweenness):` 0.000323 | `Ripple Effect (Closeness):` 0.025316
  * `Imports (Out-Degree: 4):` gitgalaxy.security.manifest_parser, uuid, typing, gitgalaxy.standards.language_standards, gitgalaxy.standards.language_lens, json, logging, gitgalaxy.security.security_lens...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, unittest.mock, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, gitgalaxy.metrics.signal_processor, bypassed, gitgalaxy.standards.config_resolver, json, yaml...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Top Global Matches:** file_cluster_13: 11.263, file_cluster_8: 11.364, file_cluster_16: 11.367
- **Magnitude:** 257.28 | **LOC:** 233 | **CtrlFlow:** 61.7% | **Authorship Centralization:** 57.1%
...
* *Risk/State:* `safety_bypasses: 8`, `state_mutation: 30`, `dead_code: 1`
* *Architecture:* `api: 4`, `import: 4`
* *Defense:* `doc: 10`
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 6.355
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.019778
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 8.178
  * `Choke Point (Betweenness):` 4e-05 | `Ripple Effect (Closeness):` 0.019778
  * `Imports (Out-Degree: 1):` typing, json, logging, re, pathlib, os, fnmatch, gitgalaxy.standards.gitgalaxy_config
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, urllib.request, json, os, urllib.error
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `gitgalaxy/core/spatial_mapper.py` (PYTHON) | Magnitude: 257.28 | Delta: **0.101 IQR** | Secondary Pull: `file_cluster_8`
...
- `gitgalaxy/core/prism.py` (PYTHON) | Magnitude: 757.26 | Delta: **0.057 IQR** | Secondary Pull: `file_cluster_8`
...
- `gitgalaxy/galaxyscope.py` (PYTHON) | Magnitude: 3819.86 | Delta: **0.116 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 1899, branch: 521, structural_boundaries: 211, state_mutation: 185
...
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **68.38%** | Cog Load: 63.3646% | Debt: 0.0%
...
- `gitgalaxy/galaxyscope.py` -> **Severity: 0.277** (Bridge: 0.0035 * Flux: 79.8889%)
- `gitgalaxy/cobol_refractor_controller.py` -> **Severity: 0.036** (Bridge: 0.0004 * Flux: 98.0037%)
- `gitgalaxy/recorders/sbom_recorder.py` -> **Severity: 0.031** (Bridge: 0.0003 * Flux: 96.3267%)
- `gitgalaxy/core/detector.py` -> **Severity: 0.012** (Bridge: 0.0002 * Flux: 56.8604%)
...
- `gitgalaxy/standards/config_resolver.py` -> **Severity: 5.425** (Embedded: 0.0678 * Error Risk: 80.0%)
- `gitgalaxy/core/network_risk_sensor.py` -> **Severity: 2.444** (Embedded: 0.031 * Error Risk: 78.8215%)
- `gitgalaxy/recorders/sarif_recorder.py` -> **Severity: 1.598** (Embedded: 0.0253 * Error Risk: 63.1325%)
- `gitgalaxy/recorders/llm_recorder.py` -> **Severity: 1.536** (Embedded: 0.0198 * Error Risk: 77.6388%)
- `gitgalaxy/tools/ai_guardrails/ai_appsec_sensor.py` -> **Severity: 1.535** (Embedded: 0.0198 * Error Risk: 77.619%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `gitgalaxy/standards/config_resolver.py` -> **Severity: 1969.986** (Blast Radius: 33.638 * Doc Risk: 58.5643%)
- `gitgalaxy/metrics/tensor_scanner.py` -> **Severity: 817.8** (Blast Radius: 8.178 * Doc Risk: 100.0%)
- `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` -> **Severity: 793.6** (Blast Radius: 7.936 * Doc Risk: 100.0%)
- `gitgalaxy/standards/language_standards.py` -> **Severity: 777.299** (Blast Radius: 48.195 * Doc Risk: 16.1282%)
- `gitgalaxy/tools/network_auditing/full_api_network_map.py` -> **Severity: 775.99** (Blast Radius: 8.178 * Doc Risk: 94.8875%)
