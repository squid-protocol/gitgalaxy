...
| **Timestamp** | `2026-08-01T04:09:50.775275+00:00` |
| **Scan Duration** | `7.75s` |
| **Git Branch** | `main` |
| **Git Commit** | `dd2e8f00e1f0efa23ab1346d4b523ac3cf234d84` |
...
| Instability Exposure | 0.0 | 32.9 | 1.2 | 0.0 | 0.0 |
| Volatility Exposure | 0.0 | 91.5 | 8.7 | 0.0 | 0.0 |
...
| `tests/extraction/languages` | 20 | 1730.46 | 2.31% | 0.0% |
...
### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **749.73**
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **684.56**
...
### 5. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **661.98**
...
### 6. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **661.55**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **654.06**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **647.93**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **641.72**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` os, Yesod, time, unittest, shapes, and, ulab, com.example.Foo...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 30):` gitgalaxy.tools.ai_guardrails.ai_appsec_sensor, os, gitgalaxy.metrics.chronometer, gitgalaxy.tools.network_auditing.full_api_network_map, argparse, signal, gitgalaxy.security.manifest_parser, time...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` token, logging, collections, math, warnings, pathlib, networkx, typing...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` os, logging, statistics, re, math, gitgalaxy.standards, typing
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` logging, time, gitgalaxy.standards.language_standards, re, math, gitgalaxy.standards.gitgalaxy_config, pathlib, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 3):` logging, tiktoken, time, collections, gitgalaxy.standards.language_standards, re, bisect, math...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 6.743
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.016534
  * `Imports (Out-Degree: 0):` logging, statistics, collections, json, gitgalaxy.standards, pathlib, sqlite3, typing...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` os, unittest, subprocess, or, sys, gitgalaxy.galaxyscope, must, gitgalaxy.standards.analysis_lens...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pytest, qualified, mypack.myclass, gitgalaxy.standards.language_standards, Control.Monad, network, matlab.unittest., machine...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` os, logging, json, re, pathlib, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` os, logging, time, shutil, subprocess, gitgalaxy.standards, pathlib, gitgalaxy.standards.config_resolver...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pytest, logging, gitgalaxy.core.spatial_mapper, with, gitgalaxy.core.prism, gitgalaxy.standards.language_standards, re, math...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` logging, collections, numpy, xgboost, pathlib, pandas, networkx, typing...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pytest, ..., java.util.List, gitgalaxy.standards.language_standards, com.example.MyClass, java.util., pathlib, sys...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` ast, argparse, json, pathlib, sys, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 357.2 | **LOC:** 12651 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` scala.util.chaining., file, was, inside, path, re, java.util., scala.util....
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` yaml, logging, __future__, dataclasses, gitgalaxy.standards, copy, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pytest, os, identity, json, gitgalaxy.metrics.signal_processor, tempfile, gitgalaxy.recorders.sarif_recorder, which
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pytest, yaml, unittest.mock, policy, bypassed, json, gitgalaxy.metrics.signal_processor, gitgalaxy.tools.supply_chain_security.supply_chain_firewall...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` org.slf4j.Logger, org.slf4j.LoggerFactory, gitgalaxy.tools.cobol_to_java.cobol_to_java_build_forge, argparse, gitgalaxy.tools.cobol_to_java.cobol_to_java_service_forge, shutil, gitgalaxy.tools.cobol_to_java.cobol_to_java_decoder_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_agent_forge...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 4):` os, datetime, logging, typing, gitgalaxy.security.manifest_parser, json, gitgalaxy.standards.language_standards, gitgalaxy.standards.gitgalaxy_config...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
- `gitgalaxy/recorders/llm_recorder.py` -> Churn: **69.16%** | Cog Load: 62.8023% | Debt: 0.0%
...
- `gitgalaxy/standards/language_standards.py` -> **Severity: 1258.748** (Blast Radius: 73.664 * Doc Risk: 17.0877%)
