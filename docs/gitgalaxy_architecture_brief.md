...
| **Timestamp** | `2026-08-21T11:33:16.491079+00:00` |
| **Scan Duration** | `5.05s` |
| **Git Branch** | `main` |
| **Git Commit** | `8f34439c7d1366c5dc6fe130a3580c30326efc0c` |
...
|---|---|---|---|---|
| `tests/extraction/languages` | 92 | 13212.47 | 3.33% | 0.0% |
| `tests/core_engine` | 22 | 2388.84 | 2.82% | 0.0% |
| `gitgalaxy` | 6 | 1754.78 | 8.62% | 0.0% |
| `gitgalaxy/core` | 9 | 1304.24 | 14.25% | 6.55% |
...
- `gitgalaxy/core/detector.py` -> **18.2708%** Exposure
...
### 1. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **499.81**
...
### 2. `gitgalaxy/core/detector.py` (PYTHON) -> Cumulative Risk: **471.43**
- **Archetype:** `file_cluster_8` (Distance: 12.574 IQR)
- **Magnitude:** 326.8 | **LOC:** 5197 | **CtrlFlow:** 75.5% | **Authorship Centralization:** 90.9%
- **Primary Risk Drivers:** Spec Match (100.0%), Churn (100.0%), Verification (80.0%), Safety Score (59.8473%)
- **Heaviest Functions:** `_classify_function` (Impact: 46.8), `_resolve_class_start_match` (Impact: 31.8), `get_token_mass` (Impact: 6.4)

### 3. `gitgalaxy/recorders/llm_recorder.py` (PYTHON) -> Cumulative Risk: **457.43**
...
### 6. `gitgalaxy/metrics/signal_processor.py` (PYTHON) -> Cumulative Risk: **423.56**
...
### 10. `gitgalaxy/core/network_risk_sensor.py` (PYTHON) -> Cumulative Risk: **392.01**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 29):` signal, gitgalaxy.core.spatial_mapper, typing, re, gitgalaxy.core.aperture, gitgalaxy.security.security_auditor, subprocess, gitgalaxy.core.spatial_correlation...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, re, pathlib, gitgalaxy.standards.language_standards, pytest, _strict_harness
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` statistics, json, collections, typing, pathlib, gitgalaxy.standards, heapq, logging...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.standards.gitgalaxy_config, gitgalaxy.core.spatial_mapper, re, gitgalaxy.core.detector, gitgalaxy.standards.language_standards, gitgalaxy.core.prism, math, logging...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` _extraction_harness, sys, only, pathlib, typing, gitgalaxy.standards.language_standards, pytest
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, this, pathlib, gitgalaxy.standards.language_standards, pytest, and, _strict_harness
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` json, typing, pathlib, re, logging, os
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` name, gitgalaxy.core.aperture, re, or, subprocess, unittest, gitgalaxy.standards.analysis_lens, tempfile...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` java.util.List, _extraction_harness, sys, only, pathlib, typing, gitgalaxy.standards.language_standards, pytest...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` _extraction_harness, sys, pathlib, gitgalaxy.standards.language_standards, pytest
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` statistics, typing, re, gitgalaxy.standards, math, logging, os
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` gitgalaxy.standards.gitgalaxy_config, contextlib, typing, re, pathlib, gitgalaxy.standards.language_standards, math, logging...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Top Global Matches:** file_cluster_8: 12.574, file_cluster_16: 12.794, file_cluster_13: 12.835
- **Magnitude:** 326.8 | **LOC:** 5197 | **CtrlFlow:** 75.5% | **Authorship Centralization:** 90.9%
- **Risk Profile:** Cognitive Load (17.5994%), Tech Debt (18.2708%)
**Top Internal Functions/Classes:**
...
* *Risk/State:* `safety_bypasses: 63`, `state_mutation: 161`, `dead_code: 30`, `planned_debt: 1`, `fragile_debt: 17`
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 2):` collections, hashlib, typing, re, tiktoken, gitgalaxy.standards.language_standards, math, gitgalaxy.core.spatial_correlation...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` json, identity, logging, os, pytest, gitgalaxy.recorders.sarif_recorder, gitgalaxy.metrics.signal_processor, tempfile...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` networkx.algorithms, collections, typing, pathlib, token, math, logging, gitgalaxy.standards.analysis_lens...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` collections, typing, pathlib, logging, gitgalaxy.standards.analysis_lens, pandas, xgboost, numpy...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, re, pathlib, gitgalaxy.standards.language_standards, shapes, pytest, _strict_harness, multiprocessing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `gitgalaxy/core/detector.py` -> **Joe Esquibel** (90.9% isolated ownership) | Magnitude: 326.8
...
- `gitgalaxy/core/detector.py` -> **Severity: 0.017** (Bridge: 0.0003 * Flux: 52.5441%)
...
- `gitgalaxy/core/detector.py` -> **Severity: 3.1** (Embedded: 0.0518 * Error Risk: 59.8473%)
...
- `gitgalaxy/core/detector.py` -> **Severity: 247.259** (Blast Radius: 14.261 * Doc Risk: 17.3381%)
