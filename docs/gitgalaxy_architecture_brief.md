...
| **Timestamp** | `2026-07-26T19:24:46.566631+00:00` |
| **Scan Duration** | `6.07s` |
| **Git Branch** | `main` |
| **Git Commit** | `9d909bd94a1171319c9a8a5e3c0ce539689b1f8d` |
...
| `tests/core_engine` | 17 | 3301.78 | 2.63% | 0.0% |
| `gitgalaxy/metrics` | 5 | 3149.06 | 16.83% | 4.54% |
| `gitgalaxy/standards` | 8 | 2051.84 | 8.04% | 16.82% |
...
### 1. `gitgalaxy/core/spatial_mapper.py` (PYTHON) -> Cumulative Risk: **751.03**
...
### 2. `gitgalaxy/metrics/statistical_auditor.py` (PYTHON) -> Cumulative Risk: **685.19**
...
### 3. `gitgalaxy/galaxyscope.py` (PYTHON) -> Cumulative Risk: **676.21**
...
### 4. `gitgalaxy/cobol_refractor_controller.py` (PYTHON) -> Cumulative Risk: **662.98**
...
### 5. `gitgalaxy/tools/cobol_to_cobol/cobol_compiler_forge.py` (PYTHON) -> Cumulative Risk: **661.15**
...
### 6. `gitgalaxy/core/prism.py` (PYTHON) -> Cumulative Risk: **660.33**
...
### 7. `gitgalaxy/standards/config_resolver.py` (PYTHON) -> Cumulative Risk: **653.3**
- **Archetype:** `Unknown Archetype` (Distance: N/A IQR)
...
### 8. `gitgalaxy/metrics/chronometer.py` (PYTHON) -> Cumulative Risk: **647.01**
...
### 9. `gitgalaxy/recorders/sbom_recorder.py` (PYTHON) -> Cumulative Risk: **643.03**
...
### 10. `gitgalaxy/recorders/sarif_recorder.py` (PYTHON) -> Cumulative Risk: **637.03**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 30):` re, gitgalaxy.core.guidestar_lens, tempfile, gitgalaxy.security.security_lens, gitgalaxy.core.aperture, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, gitgalaxy.state_rehydrator, typing...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` pathlib, logging, collections, networkx.algorithms, warnings, typing, math, networkx...
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` statistics, re, logging, typing, math, gitgalaxy.standards, os
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` re, pathlib, logging, typing, math, gitgalaxy.standards.language_standards, time, gitgalaxy.standards.gitgalaxy_config
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` signatures, formatting, gitgalaxy.standards.language_standards, os, java.util., fmt, Foundation, java.util.List...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 3):` re, logging, collections, bisect, math, typing, gitgalaxy.standards.language_standards, time...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 8.108
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.019531
  * `Imports (Out-Degree: 0):` statistics, pathlib, json, heapq, logging, collections, typing, gitgalaxy.standards...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` re, failure, tempfile, gitgalaxy.core.aperture, subprocess, os, pathlib, passes...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `tests/core_engine/test_language_standards_strict.py` (PYTHON | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 752.76 | **LOC:** 1939 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` os.path, re, sys, Yesod, ccall, Brick, gitgalaxy.standards.language_standards, multiprocessing...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` shutil, pathlib, gitgalaxy.standards.config_resolver, logging, typing, time, gitgalaxy.standards, subprocess...
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pathlib, logging, collections, xgboost, typing, pandas, numpy, networkx...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 9):` sys, argparse, gitgalaxy.tools.cobol_to_cobol.cobol_microservice_slicer, pathlib, gitgalaxy.tools.cobol_to_cobol.cobol_schema_forge, json, gitgalaxy.tools.cobol_to_cobol.cobol_graveyard_finder, datetime...
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` re, unittest.mock, logging, gitgalaxy.core.spatial_mapper, with, math, gitgalaxy.core.detector, pytest
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, argparse, pathlib, json, typing, ast
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` dataclasses, logging, __future__, typing, copy, gitgalaxy.standards, yaml
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `gitgalaxy/standards/language_standards.py` (PYTHON | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `Unknown Archetype` (Drift: N/A IQR)
- **Magnitude:** 352.06 | **LOC:** 10655 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` re, java.util., path, inside, keyword., typing, type
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` identity, tempfile, which, json, gitgalaxy.metrics.signal_processor, gitgalaxy.recorders.sarif_recorder, pytest, os
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 6):` gitgalaxy.tools.cobol_to_java.cobol_to_java_spring_forge, shutil, argparse, sys, pathlib, json, gitgalaxy.tools.cobol_to_java.cobol_to_java_decoder_forge, gitgalaxy.tools.cobol_to_java.cobol_to_java_agent_forge...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 4):` pathlib, json, datetime, logging, gitgalaxy.security.security_lens, gitgalaxy.security.manifest_parser, uuid, typing...
  * `Imported By (In-Degree: 3):` (Excluded from Brief to save tokens)
...
* *Network Topology:*
  * `Ecosystem Role:` Unknown | `Dependency Blast Radius (PageRank):` 0.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, pathlib, json, gitgalaxy.standards.config_resolver, unittest.mock, gitgalaxy.tools.supply_chain_security.supply_chain_firewall, was, gitgalaxy.metrics.signal_processor...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 8.108
  * `Choke Point (Betweenness):` 3.9e-05 | `Ripple Effect (Closeness):` 0.019531
  * `Imports (Out-Degree: 1):` re, pathlib, json, logging, typing, gitgalaxy.standards.gitgalaxy_config, os, fnmatch
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
- `gitgalaxy/standards/language_standards.py` -> **Severity: 738.785** (Blast Radius: 47.785 * Doc Risk: 15.4606%)
