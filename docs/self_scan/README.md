...
corpus (`v1.3.0` as of this writing — see `tests/_crucible_pin.py` or the `LANGUAGE_CRUCIBLE_REF`
...
git clone --branch v1.3.0 --depth 1 https://github.com/squid-protocol/language-crucible.git ../language-crucible
