...
*2-vs-1 -- 215 occurrences as of 2026-08-29T18:58:41Z*
...
*2-vs-1 -- 37 occurrences as of 2026-08-29T18:58:41Z*
...
*2-vs-1 -- 26 occurrences as of 2026-08-29T18:58:43Z*
...
| cosmopolitan/ape.S | `__ro` | *(n/a)* | *(n/a)* | 56 |
| cosmopolitan/ape.S | `_gdt_end` | *(n/a)* | *(n/a)* | 1216 |
| cosmopolitan/ape.S | `_gdtr` | *(n/a)* | *(n/a)* | 1266 |
| cosmopolitan/ape.S | `_gdtrlo` | *(n/a)* | *(n/a)* | 1262 |

### ✅ `assembly` function existence: GitGalaxy agree, ctags differ

*2-vs-1 -- 2 occurrences as of 2026-08-29T18:58:43Z*
...
*2-vs-1 -- 74 occurrences as of 2026-08-29T18:58:49Z*
...
*2-vs-1 -- 13 occurrences as of 2026-08-29T18:58:49Z*
...
*2-vs-1 -- 7 occurrences as of 2026-08-29T18:58:49Z*
...
*2-vs-1 -- 4 occurrences as of 2026-08-29T18:58:49Z*
...
*2-vs-1 -- 3 occurrences as of 2026-08-29T18:58:49Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T18:58:49Z*
...
*2-vs-1 -- 1316 occurrences as of 2026-08-29T18:59:04Z*
...
*2-vs-1 -- 6 occurrences as of 2026-08-29T18:59:04Z*
...
*2-vs-1 -- 2 occurrences as of 2026-08-29T18:59:04Z*
...
*2-vs-1 -- 200 occurrences as of 2026-08-29T18:59:11Z*
...
*2-vs-1 -- 66 occurrences as of 2026-08-29T18:59:11Z*
...
*2-vs-1 -- 30 occurrences as of 2026-08-29T18:59:11Z*
...
*2-vs-1 -- 12 occurrences as of 2026-08-29T18:59:11Z*
...
| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| godot/object.h | `operator Ref` | 1035 | *(n/a)* | *(n/a)* |
| godot/variant.cpp | `Variant::operator ::RID` | 2002 | *(n/a)* | *(n/a)* |
| godot/variant.cpp | `Variant::operator Vector` | 2219 | *(n/a)* | *(n/a)* |
| godot/variant.cpp | `Variant::operator Vector` | 2229 | *(n/a)* | *(n/a)* |
| godot/variant.cpp | `Variant::operator Vector` | 2247 | *(n/a)* | *(n/a)* |
| godot/variant.cpp | `Variant::operator Vector` | 2266 | *(n/a)* | *(n/a)* |
| godot/variant.cpp | `Variant::operator Vector` | 2283 | *(n/a)* | *(n/a)* |
| godot/variant.cpp | `Variant::operator ::AABB` | 1882 | *(n/a)* | *(n/a)* |
| godot/variant.cpp | `Variant::operator Object *` | 2024 | *(n/a)* | *(n/a)* |
| godot/variant.h | `operator BitField` | 478 | *(n/a)* | *(n/a)* |

### ✅ `cpp` function existence: GitGalaxy, tree-sitter agree, ctags differ

*2-vs-1 -- 9 occurrences as of 2026-08-29T18:59:11Z*
...
*2-vs-1 -- 2 occurrences as of 2026-08-29T18:59:11Z*
...
*2-vs-1 -- 271 occurrences as of 2026-08-29T18:59:17Z*
...
*2-vs-1 -- 108 occurrences as of 2026-08-29T18:59:17Z*
...
*2-vs-1 -- 46 occurrences as of 2026-08-29T18:59:17Z*
...
*2-vs-1 -- 9 occurrences as of 2026-08-29T18:59:17Z*
...
*2-vs-1 -- 2 occurrences as of 2026-08-29T18:59:17Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T18:59:17Z*
...
*2-vs-1 -- 3 occurrences as of 2026-08-29T18:59:18Z*
...
*2-vs-1 -- 12 occurrences as of 2026-08-29T18:59:23Z*
...
| flutter/editable_text.dart | `_CodePointBoundary` | 5327 | *(n/a)* | *(n/a)* |
| flutter/editable_text.dart | `_documentBoundary` | 5329 | *(n/a)* | *(n/a)* |
...
*2-vs-1 -- 9 occurrences as of 2026-08-29T18:59:23Z*
...
*2-vs-1 -- 15 occurrences as of 2026-08-29T18:59:29Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T18:59:29Z*
...
*2-vs-1 -- 75 occurrences as of 2026-08-29T18:59:32Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T18:59:34Z*
...
*2-vs-1 -- 102 occurrences as of 2026-08-29T18:59:34Z*
...
*2-vs-1 -- 69 occurrences as of 2026-08-29T18:59:34Z*
...
*2-vs-1 -- 16 occurrences as of 2026-08-29T18:59:34Z*
...
*3-way split -- 9 occurrences as of 2026-08-29T18:59:34Z*
...
### ❓ `html` function existence: GitGalaxy agree, tree-sitter, ctags differ

*2-vs-1 -- 1 occurrence as of 2026-08-29T18:59:35Z*

**Not yet investigated.** See `docs/self_scan/how_to_investigate_a_discrepancy.md` for the process -- read the source at a few examples below, then hand-edit this entry (`html/function/existence/agree[gitgalaxy]_vs[ctags,tree_sitter]`) in `tri_comparison_ledger.json`.

| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| cpython_jinja/layout.html | `media` | 40 | *(n/a)* | *(n/a)* |

## javascript

### ✅ `javascript` function existence: GitGalaxy, tree-sitter agree, ctags differ

*2-vs-1 -- 265 occurrences as of 2026-08-29T18:59:39Z*
...
*2-vs-1 -- 189 occurrences as of 2026-08-29T18:59:39Z*
...
*2-vs-1 -- 93 occurrences as of 2026-08-29T18:59:39Z*
...
*2-vs-1 -- 13 occurrences as of 2026-08-29T18:59:39Z*
...
*2-vs-1 -- 7 occurrences as of 2026-08-29T18:59:39Z*
...
*2-vs-1 -- 6 occurrences as of 2026-08-29T18:59:39Z*
...
*2-vs-1 -- 15 occurrences as of 2026-08-29T18:59:41Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T18:59:41Z*
...
*2-vs-1 -- 483 occurrences as of 2026-08-29T18:59:47Z*
...
*2-vs-1 -- 51 occurrences as of 2026-08-29T18:59:47Z*

**Verdict** (by Claude Sonnet 5, dispatched via tri-comparison-ledger-sweep, 2026-08-29):
> GitGalaxy Mode-D slicing recall gap -- the same #1262 class of bug ruby had ('0/117 real methods detected'). GitGalaxy's lua `func_start` regex matched every one of these in isolation (B/close/F/report/round/createfiles/f/DC all return True from func_start.finditer on the raw file), so the raw `struct_func_start` signal was fine -- but `_slice_by_keywords`' stack-depth scan only ever emits the OUTERMOST open scope's satellite, so a `function` / `local function` declared inside a `do` block, nested in another function's body, or after a keyword-count desync was folded into the enclosing satellite instead of getting its own FunctionNode. Fixed IN THIS PASS by two engine changes: (1) a `function_opener` for lua in detector.py's ScopeParsingRegistry (a second, nesting-independent pass over every real declaration line, exactly ruby's own #1262 mechanism); (2) `_apply_literal_shield` was mis-treating `#` (Lua's length operator) and `//` (floor division) as comment markers and did not shield Lua long-bracket literals `[[ ... ]]` / `--[[ ... ]]` at all -- so `for i = 1, #arg do ... end` lost its `end` from the keyword count (a +1 desync per vararg loop that cascaded into an oversized `_[Truncated]` remnant) and `function`/`for` tokens inside `[[ ]]` string bodies were mis-sliced as declarations. Net: lua named-function extraction 517 -> 564, tree-sitter-accuracy found_functions 505 -> 557 / extra_functions 12 -> 7 (BOTH golden masters re-blessed, lua baseline regenerated), this shape ~82 -> ~33. The residual ~33 are (a) declarations swallowed by a segmentation split where an embedded-markup `[[ ]]` string straddles a function boundary (`binarytrees.lua:WriteForm`, redbean HTML demos) -- routed to #2440 -- and (b) dotted/method declaration heads `function a.b.c.f1()` / `function a:deep()` the `function_opener` line-start pattern does not yet widen to -- routed to #2438.

| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| cosmopolitan/all.lua | `report` | *(n/a)* | 141 | 141 |
| cosmopolitan/api.lua | `B` | *(n/a)* | 317 | 317 |
| cosmopolitan/attrib.lua | `f` | *(n/a)* | 345 | 345 |
| cosmopolitan/attrib.lua | `f` | *(n/a)* | 406 | 406 |
| cosmopolitan/binarytrees.lua | `WriteForm` | *(n/a)* | 49 | 49 |
| cosmopolitan/calls.lua | `f` | *(n/a)* | 19 | 19 |
| cosmopolitan/calls.lua | `f` | *(n/a)* | 67 | 331 |
| cosmopolitan/calls.lua | `f` | *(n/a)* | 269 | 269 |
| cosmopolitan/calls.lua | `deep` | *(n/a)* | 119 | 119 |
| cosmopolitan/calls.lua | `a:x` | *(n/a)* | 41 | 41 |

### ✅ `lua` class existence: GitGalaxy agree, tree-sitter, ctags differ

*2-vs-1 -- 14 occurrences as of 2026-08-29T18:59:47Z*

**Verdict** (by Claude Sonnet 5, dispatched via tri-comparison-ledger-sweep, 2026-08-29):
> Lua has NO class syntax -- tree-sitter-lua has no class-shaped node type and Universal Ctags' Lua kind table has no class kind (`ctags_reader.py`'s lua CTAGS_CLASS_KINDS is the empty set), so both structurally report 0 lua classes on every file, forever. GitGalaxy's `class_start` is a deliberate best-effort heuristic for the Lua proto-table OOP idiom (`Account = {}; Account.__index = Account; function Account.new() ...`): `^ (local )? (export )? (type )? [A-Z]\w* (?= = {)`, i.e. a Capitalised name assigned a table literal. Of the 14 it flags, some are real entity-shaped tables (`pandoc/extensions.lua`'s `Extensions` module table) but several are plain Capitalised DATA tables -- `redis/life.lua`'s `FISH` / `EXPLODE` / `BUTTERFLY` are Conway's-Game-of-Life cell patterns, `AA` / `K` / `A` / `U` are one/two-letter test fixtures. Same category as css/html classes (`_CLASS_EXTRACTION_OUT_OF_SCOPE` in tree_sitter_accuracy_audit.py): a signal GitGalaxy emits by heuristic for cross-language schema comparability, with no ground-truth tool able to corroborate or refute it. The heuristic's looseness (catches ALL_CAPS data tables) is worth tightening -- routed to #2439 -- but the tree-sitter/ctags 0 is a structural absence, not a refutation.

| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| cosmopolitan/api.lua | `Arr` | *(n/a)* | *(n/a)* | *(n/a)* |
| cosmopolitan/attrib.lua | `AA` | *(n/a)* | *(n/a)* | *(n/a)* |
| cosmopolitan/coroutine.lua | `C` | *(n/a)* | *(n/a)* | *(n/a)* |
| cosmopolitan/gc.lua | `K` | *(n/a)* | *(n/a)* | *(n/a)* |
| cosmopolitan/gengc.lua | `U` | *(n/a)* | *(n/a)* | *(n/a)* |
| cosmopolitan/gengc.lua | `A` | *(n/a)* | *(n/a)* | *(n/a)* |
| cosmopolitan/sort.lua | `AA` | *(n/a)* | *(n/a)* | *(n/a)* |
| cosmopolitan/tracegc.lua | `M` | *(n/a)* | *(n/a)* | *(n/a)* |
| pandoc/extensions.lua | `Extensions` | *(n/a)* | *(n/a)* | *(n/a)* |
| redis/life.lua | `HEART` | *(n/a)* | *(n/a)* | *(n/a)* |

### ✅ `lua` function existence: tree-sitter agree, GitGalaxy, ctags differ

*2-vs-1 -- 12 occurrences as of 2026-08-29T18:59:47Z*

**Verdict** (by Claude Sonnet 5, dispatched via tri-comparison-ledger-sweep, 2026-08-29):
> Genuine architectural tradeoff -- tree-sitter-lua descends into function BODIES and names every nested `function` / `local function` (`calls.lua`: `a:add`, `a.b.c:f2`, `foo1` inside another function's body; `closure.lua` inner closures), while BOTH GitGalaxy's Mode-D extractor (deliberately `scope_depth == 0`-only for the primary satellite scan, plus the new `function_opener` nesting pass which still won't reach two levels deep) AND Universal Ctags' single-pass scanner report only the top-level / one-level declarations. This is the same 'GitGalaxy + ctags agree on a deliberate scope boundary, tree-sitter does full nesting' shape already documented for shell (`moby/check-config.sh::zgrep`, nested inside an `if ! command -v zgrep; then ... fi` guard). Not a GitGalaxy defect: recording every arbitrarily-deep nested closure as a peer FunctionNode is a design choice GitGalaxy deliberately does not make. tree-sitter's reading is the more complete one; GitGalaxy and ctags' is the more consistent-across-eras one.

| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| cosmopolitan/calls.lua | `foo` | *(n/a)* | 126 | *(n/a)* |
| cosmopolitan/calls.lua | `foo` | *(n/a)* | 143 | *(n/a)* |
| cosmopolitan/calls.lua | `a:add` | *(n/a)* | 53 | *(n/a)* |
| cosmopolitan/calls.lua | `a.b.c:f2` | *(n/a)* | 60 | *(n/a)* |
| cosmopolitan/db.lua | `foo1` | *(n/a)* | 546 | *(n/a)* |
| cosmopolitan/db.lua | `foo1` | *(n/a)* | 570 | *(n/a)* |
| cosmopolitan/db.lua | `foo2` | *(n/a)* | 571 | *(n/a)* |
| cosmopolitan/db.lua | `h` | *(n/a)* | 622 | *(n/a)* |
| cosmopolitan/events.lua | `Op` | *(n/a)* | 227 | *(n/a)* |
| cosmopolitan/locals.lua | `f` | *(n/a)* | 16 | *(n/a)* |

### ✅ `lua` function existence: GitGalaxy agree, tree-sitter, ctags differ

*2-vs-1 -- 7 occurrences as of 2026-08-29T18:59:47Z*

**Verdict** (by Claude Sonnet 5, dispatched via tri-comparison-ledger-sweep, 2026-08-29):
> GitGalaxy artifacts of a lua segmentation split -- NOT real functions. The 4 remaining occurrences are `<name>_[Truncated]` satellites in redbean demo files (`binarytrees.lua`, `events.lua`, `fetch.lua`, `maxmind.lua`) that build an HTML page from a `Write([[<!doctype html> ... ]])` long-bracket string: detector.py's mid-file language switcher runs on text where the Lua `[[ ]]` literal is not shielded, carves the embedded HTML/CSS into its own segment, and that boundary lands INSIDE the enclosing Lua function -- so `_slice_by_keywords` gets a segment starting mid-function and emits one oversized `_[Truncated]` satellite plus a spurious second `__global_context__`. Root cause routed to #2440 (polyglot segmentation must respect Lua long-bracket boundaries). This pass already fixed the OTHER, distinct desync source -- `#`/`//` mis-read as comment markers and unshielded `[[ ]]` bodies corrupting the Mode-D keyword count itself (`bit.bnot_[Truncated]`, `code.lua`'s `Anonymous_Block_[Truncated]`, `coroutine.lua`'s `new_[Truncated]` all resolved); at the `_slice_by_keywords` level every one of these 4 files now has a perfectly balanced keyword count, confirming the truncation is introduced upstream by segmentation, not by Mode D. The lone non-truncated GitGalaxy-only name (`fetch.lua:as`) is a variable in `local response = ... .as` mis-read as a declaration head. ctags and tree-sitter (which never segment this way) correctly have no equivalent for any of these. #2437 (a true keyword-count desync) has no remaining lua repro after this pass; the residual is entirely #2440.

| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| cosmopolitan/binarytrees.lua | `BinaryTreesDemo_[Truncated]` | 112 | *(n/a)* | *(n/a)* |
| cosmopolitan/binarytrees.lua | `main` | 242 | *(n/a)* | *(n/a)* |
| cosmopolitan/binarytrees.lua | `WriteForm_[Truncated]` | 49 | *(n/a)* | *(n/a)* |
| cosmopolitan/events.lua | `Anonymous_Block_[Truncated]` | 319 | *(n/a)* | *(n/a)* |
| cosmopolitan/fetch.lua | `as` | 22 | *(n/a)* | *(n/a)* |
| cosmopolitan/fetch.lua | `WriteForm_[Truncated]` | 3 | *(n/a)* | *(n/a)* |
| cosmopolitan/maxmind.lua | `main_[Truncated]` | 254 | *(n/a)* | *(n/a)* |

### ✅ `lua` function existence: GitGalaxy, tree-sitter agree, ctags differ

*2-vs-1 -- 6 occurrences as of 2026-08-29T18:59:47Z*
...
| cosmopolitan/db.lua | `a:f` | 459 | 458 | *(n/a)* |
| cosmopolitan/errors.lua | `auxy` | 471 | 471 | *(n/a)* |
| cosmopolitan/nextvar.lua | `mp2` | 90 | 90 | *(n/a)* |

### ✅ `lua` function args: none agree, GitGalaxy, tree-sitter differ

*3-way split -- 39 occurrences as of 2026-08-29T18:59:47Z*
...
| cosmopolitan/coroutine.lua | `foo` | 2 | 1 | *(n/a)* |

## m4

### ✅ `m4` function existence: ctags agree, GitGalaxy differ

*2-vs-1 -- 76 occurrences as of 2026-08-29T18:59:48Z*
...
*2-vs-1 -- 36 occurrences as of 2026-08-29T18:59:48Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T18:59:49Z*
...
*3-way split -- 1 occurrence as of 2026-08-29T18:59:50Z*
...
*2-vs-1 -- 104 occurrences as of 2026-08-29T18:59:51Z*
...
*2-vs-1 -- 89 occurrences as of 2026-08-29T18:59:51Z*
...
*2-vs-1 -- 2 occurrences as of 2026-08-29T18:59:51Z*
...
| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| worldwideweb/HyperText.m | `next_input_block` | 1147 | *(n/a)* | 1148 |
| worldwideweb/HyperText.m | `appendEndBlock` | 1289 | *(n/a)* | 1290 |
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T18:59:51Z*
...
*2-vs-1 -- 122 occurrences as of 2026-08-29T18:59:59Z*
...
*2-vs-1 -- 7 occurrences as of 2026-08-29T18:59:59Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T18:59:59Z*
...
*3-way split -- 12 occurrences as of 2026-08-29T18:59:59Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T19:00:04Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T19:00:08Z*
...
| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| PowerToys/generate-interface.ps1 | `ProviderType` | *(n/a)* | *(n/a)* | *(n/a)* |

### ✅ `powershell` function existence: GitGalaxy, tree-sitter agree, ctags differ

*2-vs-1 -- 16 occurrences as of 2026-08-29T19:00:08Z*
...
*2-vs-1 -- 9 occurrences as of 2026-08-29T19:00:08Z*
...
*3-way split -- 5 occurrences as of 2026-08-29T19:00:08Z*
...
*2-vs-1 -- 100 occurrences as of 2026-08-29T19:00:20Z*
...
*2-vs-1 -- 4 occurrences as of 2026-08-29T19:00:20Z*
...
*2-vs-1 -- 6 occurrences as of 2026-08-29T19:00:21Z*
...
*2-vs-1 -- 3 occurrences as of 2026-08-29T19:00:21Z*
...
*2-vs-1 -- 2 occurrences as of 2026-08-29T19:00:21Z*
...
*2-vs-1 -- 152 occurrences as of 2026-08-29T19:00:26Z*
...
*2-vs-1 -- 25 occurrences as of 2026-08-29T19:00:26Z*
...
*2-vs-1 -- 3 occurrences as of 2026-08-29T19:00:26Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T19:00:26Z*
...
*3-way split -- 16 occurrences as of 2026-08-29T19:00:28Z*
...
*2-vs-1 -- 84 occurrences as of 2026-08-29T19:00:32Z*
...
*2-vs-1 -- 50 occurrences as of 2026-08-29T19:00:32Z*
...
*2-vs-1 -- 41 occurrences as of 2026-08-29T19:00:36Z*
...
*2-vs-1 -- 14 occurrences as of 2026-08-29T19:00:36Z*
...
*2-vs-1 -- 2 occurrences as of 2026-08-29T19:00:36Z*
...
| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| freebsd-src/runulp.sh | `t` | *(n/a)* | 22 | 22 |
| moby/check-config.sh | `zgrep` | *(n/a)* | 23 | 23 |

### ✅ `shell` function existence: GitGalaxy agree, tree-sitter, ctags differ

*2-vs-1 -- 1 occurrence as of 2026-08-29T19:00:36Z*

**Verdict** (by Claude (Sonnet 5), direct investigation via tri-comparison-ledger-sweep, 2026-08-28T23:59:00Z):
> All 3 remaining occurrences are GitGalaxy over-detection artifacts, not real functions that ctags and tree-sitter both miss. `runulp.sh::t_[Truncated]` and `serenity/builtin.sh::_complete_unalias_[Truncated]` are the SAME functions GitGalaxy reports as missed in `shell/function/existence/agree[ctags,tree_sitter]_vs[gitgalaxy]`: a Mode-D scope-stack desync leaves the enclosing block open to EOF, so `_slice_by_keywords` emits one file-spanning `<name>_[Truncated]` satellite under a mangled name instead of the real function. `serenity/run-tests-and-shutdown.sh::Anonymous_Block_[Truncated]` is the same mechanism on a SerenityOS Shell `if ... { ... }` brace block that GitGalaxy's POSIX-oriented opener/closer set cannot balance. Zero genuine GitGalaxy-only true positives. The two remaining triggers (a bare `for` keyword inside an `echo` argument in runulp.sh; SerenityOS non-POSIX `if...{` block syntax) are filed as GH #2405. No credit: GitGalaxy is a lone claimant and its claim is not real, so the false positives already count against its precision with no adjustment. This shape was 7 occurrences before this PR; the `--`/`//` bogus-comment-marker fix and heredoc-delimiter-preservation fix (gitgalaxy/core/detector.py) cleared the other 4.

| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| freebsd-src/runulp.sh | `t_[Truncated]` | 22 | *(n/a)* | *(n/a)* |

### ✅ `shell` function args: none agree, GitGalaxy, tree-sitter differ

*3-way split -- 10 occurrences as of 2026-08-29T19:00:36Z*
...
| linux/prom_init_check.sh | `check_section` | 3 | 2 | *(n/a)* |

## solidity

### ✅ `solidity` function existence: GitGalaxy agree, tree-sitter differ

*2-vs-1 -- 6 occurrences as of 2026-08-29T19:00:37Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T19:00:38Z*
...
*3-way split -- 2 occurrences as of 2026-08-29T19:00:38Z*
...
*2-vs-1 -- 4 occurrences as of 2026-08-29T19:00:39Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T19:00:39Z*
...
*2-vs-1 -- 2223 occurrences as of 2026-08-29T19:00:48Z*
...
*2-vs-1 -- 501 occurrences as of 2026-08-29T19:00:48Z*
...
*2-vs-1 -- 204 occurrences as of 2026-08-29T19:00:48Z*
...
*2-vs-1 -- 3 occurrences as of 2026-08-29T19:00:48Z*
...
| file | name | GitGalaxy | tree-sitter | ctags |
|---|---|---|---|---|
| vscode/async.ts | `return` | *(n/a)* | 2059 | *(n/a)* |
| vscode/codeEditorWidget.ts | `cursorStateComputer` | *(n/a)* | 1295 | *(n/a)* |
| vscode/instantiationService.ts | `createInstance` | *(n/a)* | 118 | *(n/a)* |

### ✅ `typescript` class existence: ctags agree, GitGalaxy, tree-sitter differ

*2-vs-1 -- 2 occurrences as of 2026-08-29T19:00:48Z*
...
*2-vs-1 -- 2 occurrences as of 2026-08-29T19:00:59Z*
...
*2-vs-1 -- 1 occurrence as of 2026-08-29T19:00:59Z*
