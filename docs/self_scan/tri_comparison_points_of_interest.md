...
| haiku/HardwareChecker.sh | `detect_network_[Truncated]` | 66 | *(n/a)* | *(n/a)* |
| illumos-gate/exportfs.sh | `Anonymous_Block_[Truncated]` | 69 | *(n/a)* | *(n/a)* |
| linux/multisound.sh | `Anonymous_Block_[Truncated]` | 446 | *(n/a)* | *(n/a)* |
...
| sqlite/split-speedtest1-script.sh | `Anonymous_Block_[Truncated]` | 4 | *(n/a)* | *(n/a)* |
...
| haiku/HardwareChecker.sh | `detect_network` | *(n/a)* | 65 | 65 |
| haiku/HardwareChecker.sh | `check_pci` | *(n/a)* | 89 | 89 |
| haiku/HardwareChecker.sh | `check_usb` | *(n/a)* | 162 | 162 |
| haiku/HardwareChecker.sh | `check_dmidecode` | *(n/a)* | 212 | 212 |
| haiku/HardwareChecker.sh | `check_machine` | *(n/a)* | 235 | 235 |
| haiku/HardwareChecker.sh | `check_haiku` | *(n/a)* | 249 | 249 |
| haiku/HardwareChecker.sh | `check_utils` | *(n/a)* | 263 | 263 |
| haiku/HardwareChecker.sh | `check_syslog` | *(n/a)* | 301 | 301 |
