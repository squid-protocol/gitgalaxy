...
class SarifRecorder:
    ...
    def generate_report(
                    ...
                    "invocations": [
                        {
                            ...
                            "toolExecutionNotifications": self._build_dependency_notifications(
                                is_zero_dep, missing_deps
                            ),
                        }
                    ],
                    "results": [],
        ...
        for node in parsed_files or []:
                ...
                results_list.append(
                    {
                        ...
                        "properties": {"category": "Machine Learning Inference", "precision": confidence},
                    }
                )
            ...
            for threat_type, snippets in threat_snippets.items():
                ...
                for idx, snippet in enumerate(snippets):
                    ...
                    severity = (
                        "error"
                        if any(x in threat_type for x in ["secret", "injection", "execution", "corruption"])
                        else "warning"
                    )
                    ...
                    results_list.append(
                        {
                            ...
                            "level": severity,
                            "message": {"text": f"Vulnerability signature triggered: {snippet}"},
                            "locations": [self._build_location(rel_path, exact_line)],
                            "properties": {"category": "Structural SAST"},
                        }
                    )
        ...
        try:
            ...
            self.logger.error(f"SARIF: Export failed - {e!s}", exc_info=True)
        ...
        return [
            {
                ...
                "fullDescription": {
                    "text": "A hardcoded credential, API key, or cryptographic secret was detected in the source code."
                },
            ...
            },
            {
                ...
                "fullDescription": {
                    "text": "Detected usage of dynamic execution (eval, exec, subprocess) which can lead to Remote Code Execution if tainted by user input."
                },
            ...
            },
            {
                ...
                "fullDescription": {
                    "text": "This file's structural complexity, downstream exposure, or state flux makes it unsafe for autonomous AI agents to edit. Human-in-the-Loop (HITL) supervision is strictly required to prevent architectural degradation or hallucinated logic."
                },
            ...
            },
            {
                ...
                "fullDescription": {
                    "text": "The XGBoost inference engine detected high-entropy structural topologies consistent with Trojans or Credential Stealers."
                },
