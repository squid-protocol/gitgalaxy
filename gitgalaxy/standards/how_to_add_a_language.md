...
pytest module in the shape of `tests/core_engine/languages/test_<lang>.py`'s existing files (see
e.g. `tests/core_engine/languages/test_php.py`'s `_PHP_SIMPLE_CASES` / `test_php_*` for a concrete
template).
