...
LANGUAGE_DEFINITIONS: dict[str, Any] = {
    ...
    "c": {
        ...
        "rules": {
            ...
            # (tests/core_engine/languages/test_c.py) documents that co-firing as DELIBERATE: it's how
    ...
    "makefile": {
        ...
        "rules": {
            ...
            # is intentional, not an oversight: tests/core_engine/languages/test_makefile
