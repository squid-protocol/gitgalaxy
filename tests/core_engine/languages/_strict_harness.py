"""
Shared ReDoS-testing harness for tests/core_engine/languages/test_<lang>.py.

Moved verbatim out of the top of tests/core_engine/test_language_standards_strict.py
when that file was split into one file per language (mirroring
tests/extraction/_extraction_harness.py's role for the extraction gauntlets).
"""
