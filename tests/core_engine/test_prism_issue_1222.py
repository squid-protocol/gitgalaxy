...
"""
    ...
    assert "otherMethod" in result["code_stream"], "Code after apostrophe in comment was swallowed!"
    assert "this.test = 1;" in result["code_stream"], "Code after apostrophe in comment was swallowed!"
