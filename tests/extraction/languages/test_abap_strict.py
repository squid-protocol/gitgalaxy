...
_ABAP_SIMPLE_CASES = [
    ...
    ("branch", "   ELSEIF sy-subrc = 0.", "DATA lv_x TYPE i."),
    ...
    ("args", "RECEIVING r TYPE i", "DATA lv_x TYPE i."),
    ("args", "EXCEPTIONS cx_root = 1", "DATA lv_x TYPE i."),
    ("structural_boundaries", "DATA lv_x TYPE i.", "IF lv_x = 1."),
    ("structural_boundaries", "TYPES: BEGIN OF ty_foo,", "DATA(lv_var) = 1."),
    ("structural_boundaries", "DATA: lv_var TYPE i.", "CLASS-METHODS foo."),
    ("structural_boundaries", "FIELD-SYMBOLS: <fs> TYPE ANY.", "CLASS-DATA foo."),
    ("structural_boundaries", "REPORT z_my_report.", "DATA(lv_var) = 1."),
    ("structural_boundaries", "PROGRAM z_my_prog.", "DATA(lv_var) = 1."),
    ("func_start", "METHOD do_thing.", "DATA lv_x TYPE i."),
    ("func_start", "METHOD  if_foo~bar .", "CLASS-METHODS foo."),
    ("func_start", "METHOD if_foo~bar BY DATABASE PROCEDURE FOR HDB LANGUAGE SQLSCRIPT.", "METHODS foo."),
    ("func_start", "FUNCTION z_my_func.", "DATA lv_x TYPE i."),
    ("func_start", "FORM my_form .", "DATA lv_x TYPE i."),
    ("func_start", "MODULE pbo_100 OUTPUT.", "DATA lv_x TYPE i."),
    ("class_start", "CLASS zcl_foo DEFINITION.", "METHOD do_thing."),
    ("class_start", "CLASS zcl_bar DEFINITION PUBLIC.", "METHOD do_thing."),
    ("class_start", "INTERFACE zif_foo PUBLIC.", "METHOD do_thing."),
    ("class_start", "DEFINE ROOT VIEW ENTITY z_view_entity", "METHOD do_thing."),
    ("class_start", "DEFINE PROJECTION VIEW ENTITY z_proj_entity", "METHOD do_thing."),
    ("class_start", "DEFINE ABSTRACT ENTITY z_abstract", "METHOD do_thing."),
    ("class_start", "DEFINE CUSTOM ENTITY z_custom", "METHOD do_thing."),
    ("class_start", "DEFINE ROOT CUSTOM ENTITY z_root_custom", "METHOD do_thing."),
