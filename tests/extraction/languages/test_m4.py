...
FUNCTION_CASES: dict[str, Any] = {
    "valid": [
        # BUG FIX (2026-08-20): expected_name is the macro actually being DEFINED
        # ("TargetFunc"), not the defun keyword itself -- the pre-fix regex had no
        # capture group over the real argument and matched the keyword by default.
        ("m4_define(`TargetFunc',", "TargetFunc"),
        ("AC_DEFUN([TargetFunc],", "TargetFunc"),
        ("define(`TargetFunc',", "TargetFunc"),
        ("AC_DEFUN_ONCE([TargetFunc],", "TargetFunc"),
        ("AU_DEFUN([TargetFunc],", "TargetFunc"),
        ("m4_defun([TargetFunc],", "TargetFunc"),
    ],
    "invalid": [
        "TargetFunc()",
        "define TargetFunc",
