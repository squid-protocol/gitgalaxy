...
_EXPECTED_NONE_KEYS = {
    "test", "concurrency", "closures", "decorators", "generics", "comprehensions",
    "memory_alloc", "inline_asm", "macros", "dependency_injection", "ssr_boundaries",
    "events", "listeners", "sync_locks", "test_skip", "serialization_parsing",
    "regex_execution", "hardcoded_secrets",
}
